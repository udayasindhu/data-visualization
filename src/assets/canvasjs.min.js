...
(function () {
  ...
  function Wa(k, l, v) {
    "millisecond" === v
      ? k.setMilliseconds(k.getMilliseconds() + 1 * l)
      : "second" === v
      ? k.setSeconds(k.getSeconds() + 1 * l)
      : "minute" === v
      ? k.setMinutes(k.getMinutes() + 1 * l)
      : "hour" === v
      ? k.setHours(k.getHours() + 1 * l)
      : "day" === v
      ? k.setDate(k.getDate() + 1 * l)
      : "week" === v
      ? k.setDate(k.getDate() + 7 * l)
      : "month" === v
      ? k.setMonth(k.getMonth() + 1 * l)
      : "year" === v && k.setFullYear(k.getFullYear() + 1 * l);
    return k;
  }
  function X(k, l) {
    var v = !1;
  ...
  function fb(k) {
    if (J.fSDec)
      k[Y("`eeDwdouMhrudods")](Y("e`u`@ohl`uhnoHuds`uhnoDoe"), function () {
        J._fTWm && J._fTWm(k);
      });
  }
  function Xa(k, l, v) {
  ...
  function P(k, l, v, s, t) {
    ...
    return k.addEventListener
      ...
      ? ((s = function (l) {
        ...
        k.attachEvent("on" + l, s),
        s)
      : !1;
  }
  function gb(k) {
    if (k._menuButton) k.exportEnabled ? La(k._menuButton) : ua(k._menuButton);
    else if (k.exportEnabled && t) {
      var l = !1;
      ...
      P(
        ...
        function () {
          "none" !== k._dropdownMenu.style.display ||
            (k._dropDownCloseTime &&
              500 >= new Date().getTime() - k._dropDownCloseTime.getTime()) ||
            ((k._dropdownMenu.style.display = "block"),
            k._menuButton.blur(),
            k._dropdownMenu.focus());
        },
        k.allDOMEventHandlers,
        !0
      );
        ...
        function () {
          l ||
            ...
            0 >= navigator.userAgent.search("MSIE") &&
              pa(k, k._menuButton.childNodes[0], {
    ...
    if (!k._dropdownMenu && k.exportEnabled && t) {
      ...
      P(
        ...
        function () {
          l ||
            ((this.style.backgroundColor = k.toolbar.backgroundColorOnHover),
      ...
      P(
        ...
        function () {
          l ||
            ((this.style.backgroundColor = k.toolbar.backgroundColor),
            (this.style.color = k.toolbar.fontColor));
        },
        k.allDOMEventHandlers,
        !0
      );
  ...
  function hb(k) {
    if (!ib) {
      ...
      "undefined" === typeof qa.Chart.creditHref
        ? ((k.creditHref = Y("iuuqr;..b`ow`rkr/bnl.")),
          (k.creditText = Y("B`ow`rKR/bnl")))
        : ((l = k.updateOption("creditText")),
          (v = k.updateOption("creditHref")));
  ...
  function va(k, l, v) {
    l.getAttribute("state") ||
      ((l.style.backgroundColor = k.toolbar.backgroundColor),
    ...
    l.getAttribute("state") !== v &&
      ...
      l.setAttribute("title", k._cultureInfo[v + "Text"]),
      (l.innerHTML =
        "<img style='height:95%; pointer-events: none;' src='" +
        jb[v].image +
        "' alt='" +
        k._cultureInfo[v + "Text"] +
        "' />"));
  }
  function La() {
  ...
  function Sa(k, l, v, s, t) {
    ...
    k =
      parseFloat(k.toString()) * (0 <= k.toString().indexOf("%") ? l / 100 : 1);
    "undefined" !== typeof s &&
      ((k = Math.min(s, k)), "undefined" !== typeof t && (k = Math.max(t, k)));
  ...
  function V(k, l, v, t, w) {
    ...
    k = {};
    this.theme && s(this.parent) && s(l) && s(t)
      ? (k = s(this.predefinedThemes[this.theme])
      ...
      : this.parent &&
        ...
        (null === t
          ? (k = this.parent.themeOptions[l])
          : 0 < this.parent.themeOptions[l].length &&
            ((t = Math.min(this.parent.themeOptions[l].length - 1, t)),
            (k = this.parent.themeOptions[l][t])));
    this.themeOptions = k;
  ...
  function ya(k, l) {
    ...
    if (s(this.options.margin) && k.options.subtitles)
      for (var v = k.options.subtitles, t = 0; t < v.length; t++)
        if (
          ((s(v[t].horizontalAlign) && "center" === this.horizontalAlign) ||
            v[t].horizontalAlign === this.horizontalAlign) &&
          ((s(v[t].verticalAlign) && "top" === this.verticalAlign) ||
            v[t].verticalAlign === this.verticalAlign) &&
          !v[t].dockInsidePlotArea === !this.dockInsidePlotArea
        ) {
          this.margin = 0;
          break;
        }
  ...
  (function () {
    J.fSDec = function (k) {
      for (var l = "", v = 0; v < k.length; v++)
        l += String.fromCharCode(
          Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(v)
        );
      return l;
    };
    J.obj = {
    ...
    J.pro = { sCH: qa[J.fSDec("Bi`su")][J.fSDec("bsdehuIsdg")] };
    J._fTWm = function (k) {
      if ("undefined" === typeof J.pro.sCH && !cb)
        try {
  ...
  var Ya = {},
        ...
        return (M = N.replace(k, function (n) {
          switch (n) {
            ...
            case "K":
              return J
                ? "UTC"
                : (String(F).match(w) || [""]).pop().replace(E, "");
            case "z":
        ...
        if (((l = F[L]), "." === l && 0 > N)) N = L;
          ...
          if ("%" === l) E *= 100;
            ...
            ("E" !== l[0] && "e" !== l[0]) ||
              ...
              (R = !0);
          0 > N
            ? (M.push(l), "#" === l || "0" === l ? Q++ : "," === l && P++)
            : (I.push(l), ("#" !== l && "0" !== l) || J++);
        }
      R &&
        ((l = Math.floor(k)),
        (F = -Math.floor(Math.log(k) / Math.LN10 + 1)),
        (V = 0 === k ? 0 : 0 === l ? -(Q + F) : String(l).length - Q),
        (E /= Math.pow(10, V)));
      0 > N && (N = L);
      E = (k * E).toFixed(J);
      l = E.split(".");
        ...
        if (((l = M.pop()), "#" === l || "0" === l))
          if ((N++, N === Q)) {
            var W = E,
              E = [];
            if ("0" === l)
              for (l = Q - J - (W ? W.length : 0); 0 < l; ) W.unshift("0"), l--;
            for (; 0 < W.length; )
              (v = W.pop() + v),
                R++,
                0 === R % F && L === P && 0 < W.length && (v = w + v);
          } else
            0 < E.length
              ? ((v = E.pop() + v), J++, R++)
              : "0" === l && ((v = "0" + v), J++, R++),
              0 === R % F && L === P && 0 < E.length && (v = w + v);
        else
          ("E" !== l[0] && "e" !== l[0]) ||
          "0" !== l[l.length - 1] ||
          !/[eE][+-]*[0]+/.test(l)
            ? "," === l
              ? (L++, (F = R), (R = 0), 0 < E.length && (v = w + v))
              : (v =
                  1 < l.length &&
                  (('"' === l[0] && '"' === l[l.length - 1]) ||
                    ("'" === l[0] && "'" === l[l.length - 1]))
    ...
    Oa = function (k) {
      ...
      k.offsetX || 0 === k.offsetX
        ? ((l = k.offsetX), (v = k.offsetY))
        : k.layerX || 0 == k.layerX
        ? ((l = k.layerX), (v = k.layerY))
        : ((l = k.pageX - k.target.offsetLeft),
          (v = k.pageY - k.target.offsetTop));
      return { x: l, y: v };
    },
    $a = !0,
    ...
    Na = 1,
    ha = $a ? Ra / Na : 1,
    ba = function (k, l, v, s, t, w, E, F, N, M, R, Q, I) {
      ...
      0 < E &&
        ...
        (k.strokeStyle = F),
        k.moveTo(l, v),
        k.rect(l - I, v - I, s - l + 2 * I, t - v + 2 * I),
        k.stroke());
      k.restore();
      !0 === N &&
        (k.save(),
        ...
        k.lineTo(s, v),
        k.closePath(),
        (E = k.createLinearGradient((s + l) / 2, v + J, (s + l) / 2, v)),
        E.addColorStop(0, w),
      ...
      !0 === M &&
        ...
        k.lineTo(s, t),
        k.closePath(),
        (E = k.createLinearGradient((s + l) / 2, t - J, (s + l) / 2, t)),
        E.addColorStop(0, w),
        E.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (k.fillStyle = E),
        k.fill(),
      ...
      !0 === R &&
        ...
        k.lineTo(l, t),
        k.closePath(),
        (E = k.createLinearGradient(l + J, (t + v) / 2, l, (t + v) / 2)),
        E.addColorStop(0, w),
      ...
      !0 === Q &&
        ...
        k.lineTo(s - J, t - J),
        k.lineTo(s, t),
        (E = k.createLinearGradient(s - J, (t + v) / 2, s, (t + v) / 2)),
        E.addColorStop(0, w),
        E.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (k.fillStyle = E),
        E.addColorStop(0, w),
    ...
    Y = function (k) {
      for (var l = "", s = 0; s < k.length; s++)
        l += String.fromCharCode(
          Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(s)
        );
      return l;
    },
    cb =
      window &&
      window[Y("mnb`uhno")] &&
      window[Y("mnb`uhno")].href &&
      window[Y("mnb`uhno")].href.indexOf &&
      (-1 !== window[Y("mnb`uhno")].href.indexOf(Y("b`ow`rkr/bnl")) ||
        -1 !== window[Y("mnb`uhno")].href.indexOf(Y("gdonqhy/bnl")) ||
        -1 !== window[Y("mnb`uhno")].href.indexOf(Y("gheemd"))),
  ...
  V.prototype.setOptions = function (k, l) {
    if (qa[this._defaultsKey]) {
      ...
      for (t in s)
        "publicProperties" !== t &&
          s.hasOwnProperty(t) &&
          (this[t] = k && t in k ? k[t] : l && t in l ? l[t] : s[t]);
  ...
  V.prototype.get = function (k) {
    ...
    if (
      l.hasOwnProperty(k) ||
      (l.publicProperties && l.publicProperties.hasOwnProperty(k))
    )
      return this[k];
    window.console &&
      window.console.log(
  ...
  V.prototype.set = function (k, l, s) {
    ...
    if ("options" === k) this.createUserOptions(l);
    else if (
      t.hasOwnProperty(k) ||
      (t.publicProperties &&
        t.publicProperties.hasOwnProperty(k) &&
        "readWrite" === t.publicProperties[k])
    )
  ...
  V.prototype.addTo = function (k, l, s, t) {
    ...
    w.hasOwnProperty(k) ||
    (w.publicProperties &&
      w.publicProperties.hasOwnProperty(k) &&
      "readWrite" === w.publicProperties[k])
      ? (this.options._isPlaceholder && this.createUserOptions(),
        "undefined" === typeof this.options[k] && (this.options[k] = []),
        (k = this.options[k]),
        (s = "undefined" === typeof s || null === s ? k.length : s),
        k.splice(s, 0, l),
        t && (this.stockChart || this.chart || this).render())
      : window.console &&
        (w.publicProperties &&
        w.publicProperties.hasOwnProperty(k) &&
        "readOnly" === w.publicProperties[k]
          ? window.console.log('Property "' + k + '" is read-only.')
          : window.console.log(
              'Property "' + k + "\" doesn't exist. Please check for typo."
            ));
  ...
  V.prototype.updateOption = function (k) {
    ...
    this.theme && s(this.parent) && s(F) && s(J)
      ? (t = s(this.predefinedThemes[this.theme])
          ? this.predefinedThemes.light1
          : this.predefinedThemes[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        ...
        (null === J
          ? (t = this.parent.themeOptions[F])
          : 0 < this.parent.themeOptions[F].length &&
            ((t = Math.min(this.parent.themeOptions[F].length - 1, J)),
            (t = this.parent.themeOptions[F][t])));
    this.themeOptions = t;
    k in l &&
      (w = k in this.options ? this.options[k] : t && k in t ? t[k] : l[k]);
  ...
  V.prototype.addEventListener = function (k, l, s) {
    k &&
      ...
      this._eventListeners[k].push({ context: s || this, eventHandler: l }));
  };
  V.prototype.removeEventListener = function (k, l) {
    if (k && l && this._eventListeners[k])
      for (var s = this._eventListeners[k], t = 0; t < s.length; t++)
  ...
  Ea.prototype.registerSpace = function (k, l) {
    "top" === k
      ...
      : "right" === k && (this._rightOccupied += l.width);
  };
      ...
      for (s = 0; s < this._wrappedText.lines.length; s++)
        (F = this._wrappedText.lines[s]),
          "right" === this.horizontalAlign
            ? (t = this.width - F.width - this.rightPadding)
  ...
  ja.prototype._getLineWithWidth = function (k, l, s) {
    ...
    s > l &&
      1 < E.length &&
      ((E = E.substr(0, E.length - 1)), (s = this.ctx.measureText(E).width));
    l = !0;
  ...
  ja.prototype._wrapText = function () {
    ...
    this._wrappedText = { lines: l, width: w, height: t };
  ...
  ya.prototype.setLayout = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((w = l.y2 - 2 - M.height), (I = "bottom")),
          "left" === this.horizontalAlign
            ? (t = l.x1 + 2)
            : "center" === this.horizontalAlign
            ? (t = l.x1 + l.width / 2 - M.width / 2)
            : "right" === this.horizontalAlign && (t = l.x2 - 2 - M.width - E),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((t = l.x1 + 2),
              (w = l.y2 - 2 - (this.maxWidth / 2 - M.width / 2)),
              (F = -90),
              (I = "left"),
              (this.width = M.height),
              (this.height = M.width))
            : "right" === this.horizontalAlign
            ? ((t = l.x2 - 2),
              (w = l.y1 + 2 + (this.maxWidth / 2 - M.width / 2)),
              (F = 90),
              (I = "right"),
              (this.width = M.height),
              (this.height = M.width))
            : "center" === this.horizontalAlign &&
              ((w = k.y1 + (k.height / 2 - M.height / 2)),
              (t = k.x1 + (k.width / 2 - M.width / 2)),
              (I = "center"),
              (this.width = M.width),
              (this.height = M.height)),
          (N = "center"));
      ...
      this.bounds = { x1: t, y1: w, x2: t + this.width, y2: w + this.height };
  ...
  oa(Ja, V);
  var Pa = {
    addTheme: function (k, l) {
      bb[k] = l;
    },
    addColorSet: function (k, l) {
      za[k] = l;
    },
    addCultureInfo: function (k, l) {
      Ka[k] = l;
    },
    formatNumber: function (k, l, s) {
      s = s || "en";
      if (Ka[s]) return ea(k, l || "#,##0.##", new Ja(s));
      throw "Unknown Culture Name";
    },
    formatDate: function (k, l, s) {
      s = s || "en";
  ...
  w = Pa.Chart = (function () {
      ...
      (this.container =
        ...
        ? ((this.container.innerHTML = ""),
          ...
          (this._selectedColorSet =
            "undefined" !== typeof za[this.colorSet]
              ? za[this.colorSet]
              : za.colorSet1),
          ...
          this.canvas.getContext &&
            ...
            (this._eventManager = new ca(this)),
      ...
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b =
            (Math.abs(
              (a[n].x - a[f].x) /
                (0 === a[n].x - a[m].x ? 0.01 : a[n].x - a[m].x)
            ) *
              (d - 1)) /
              2 +
            1;
          ...
          b = (a[n].y - a[f].y) / b;
          c[c.length] =
            (a[m].x > a[f].x && 0 < A) || (a[m].x < a[f].x && 0 > A)
              ? { x: a[m].x + A / 3, y: a[m].y + b / 3 }
              : { x: a[m].x, y: a[m].y + b / 9 };
          m = e;
          f = 0 === m ? 0 : m - 1;
          n = m === a.length - 1 ? m : m + 1;
          b =
            (Math.abs(
              (a[n].x - a[f].x) /
                (0 === a[m].x - a[f].x ? 0.01 : a[m].x - a[f].x)
            ) *
              (d - 1)) /
              2 +
            1;
    ...
    function w(a, d, c, b, e, f, n, m, A, h) {
      ...
      a.beginPath();
      A && 0 < m.thickness
        ? (a.moveTo(b - n.thickness / 2, Math.round((c + e) / 2) - q),
          a.lineTo(d + n.thickness / 2, Math.round((c + e) / 2) - q))
        : 0 < m.thickness &&
          (a.moveTo(Math.round((d + b) / 2) - q, c + n.thickness / 2),
          a.lineTo(Math.round((d + b) / 2) - q, e - n.thickness / 2));
      a.stroke();
    ...
    function E(a, d, c, b, e, f) {
      ...
      this.options.crosshair &&
        (this.crosshair = new aa(this.chart, this.options.crosshair, this));
            ...
            function () {
              d
                ...
                : (pa(a, a._zoomButton, {
                  ...
                  0 >= navigator.userAgent.search("MSIE") &&
                    pa(a, a._zoomButton.childNodes[0], {
                      WebkitFilter: "invert(100%)",
                      filter: "invert(100%)",
                    }));
            },
          ...
          P(
            ...
            function () {
              d ||
                ...
                0 >= navigator.userAgent.search("MSIE") &&
                  pa(a, a._resetButton.childNodes[0], {
                    WebkitFilter: "invert(100%)",
                    filter: "invert(100%)",
                  }));
            },
          ...
          if (
            ...
            null === b.color
              ? 1 < this.options.data.length
                ? ((b._colorSet = [
                    this._selectedColorSet[
                      b.index % this._selectedColorSet.length
                    ],
                  ]),
                  (b.color = this._selectedColorSet[
                    b.index % this._selectedColorSet.length
                  ]))
                : (b._colorSet =
                    "line" === b.type ||
    ...
    l.prototype.setLayout = function () {
      ...
      c
        ? (La(this._zoomButton, this._resetButton),
          ...
          (this._resetButton.style.borderRight =
            ...
            "px solid " +
            this.toolbar.borderColor))
        : (ua(this._zoomButton, this._resetButton),
          (this._toolBar.style.border =
      ...
      this._processData();
      this.options.title &&
        ((this.title = new ya(this, this.options.title)),
    ...
    l.prototype.renderElements = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          var f = this.plotInfo.plotTypes[d], n = 0;
          n < f.plotUnits.length;
          n++
        ) {
          var m = f.plotUnits[n],
            A = null;
          m.targetCanvas = null;
          this.animatedRender &&
            ((m.targetCanvas = ta(this.width, this.height)),
            (m.targetCanvasCtx = m.targetCanvas.getContext("2d")),
            (e = m.targetCanvasCtx.miterLimit),
            (m.targetCanvasCtx.miterLimit = 3));
          "line" === m.type
            ? (A = this.renderLine(m))
            : "stepLine" === m.type
            ? (A = this.renderStepLine(m))
            : "spline" === m.type
            ? (A = this.renderSpline(m))
            : "column" === m.type
            ? (A = this.renderColumn(m))
            : "bar" === m.type
            ? (A = this.renderBar(m))
            : "area" === m.type
            ? (A = this.renderArea(m))
            : "stepArea" === m.type
            ? (A = this.renderStepArea(m))
            : "splineArea" === m.type
            ? (A = this.renderSplineArea(m))
            : "stackedColumn" === m.type
            ? (A = this.renderStackedColumn(m))
            : "stackedColumn100" === m.type
            ? (A = this.renderStackedColumn100(m))
            : "stackedBar" === m.type
            ? (A = this.renderStackedBar(m))
            : "stackedBar100" === m.type
            ? (A = this.renderStackedBar100(m))
            : "stackedArea" === m.type
            ? (A = this.renderStackedArea(m))
            : "stackedArea100" === m.type
            ? (A = this.renderStackedArea100(m))
            : "bubble" === m.type
            ? (A = A = this.renderBubble(m))
            : "scatter" === m.type
            ? (A = this.renderScatter(m))
            : "pie" === m.type
            ? this.renderPie(m)
            : "doughnut" === m.type
            ? this.renderPie(m)
            : "funnel" === m.type
            ? (A = this.renderFunnel(m))
            : "pyramid" === m.type
            ? (A = this.renderFunnel(m))
            : "candlestick" === m.type
            ? (A = this.renderCandlestick(m))
            : "ohlc" === m.type
            ? (A = this.renderCandlestick(m))
            : "rangeColumn" === m.type
            ? (A = this.renderRangeColumn(m))
            : "error" === m.type
            ? (A = this.renderError(m))
            : "rangeBar" === m.type
            ? (A = this.renderRangeBar(m))
            : "rangeArea" === m.type
            ? (A = this.renderRangeArea(m))
            : "rangeSplineArea" === m.type
            ? (A = this.renderRangeSplineArea(m))
            : "waterfall" === m.type
            ? (A = this.renderWaterfall(m))
            : "boxAndWhisker" === m.type && (A = this.renderBoxAndWhisker(m));
          for (var h = 0; h < m.dataSeriesIndexes.length; h++)
            this._dataInRenderedOrder.push(this.data[m.dataSeriesIndexes[h]]);
          this.animatedRender &&
            ((m.targetCanvasCtx.miterLimit = e), A && c.push(A));
        }
          ...
          r._animator.animate(
            ...
            function (a) {
              ...
              r.ctx.drawImage(
                ...
                0,
                0,
                Math.floor(r.width * ha),
                Math.floor(r.height * ha),
                0,
                0,
                r.width,
                r.height
              ...
              for (var e = 0; e < c.length; e++)
                (A = c[e]),
                  1 > a && "undefined" !== typeof A.startTimePercent
                    ? a >= A.startTimePercent &&
                      A.animationCallback(
                        A.easingFunction(
                          a - A.startTimePercent,
                          0,
                          1,
                          1 - A.startTimePercent
                        ),
                        A
                      )
            ...
            function () {
              ...
              for (var a = 0; a < r.plotInfo.plotTypes.length; a++)
                for (
                  var e = r.plotInfo.plotTypes[a], d = 0;
              ...
              b = null;
              r.disableToolTip = !1;
              r.dispatchEvent("dataAnimationEnd", { chart: r });
            }
          );
      else {
        if (r._breaksCanvas)
          ...
          else for (h = 0; h < r._axes.length; h++) r._axes[h].createMask();
    ...
    l.prototype.categoriseDataSeries = function () {
      for (var a = "", d = 0; d < this.data.length; d++)
        if (
          ...
          for (
            var c = null, b = !1, e = null, f = !1, n = 0;
            n < this.plotInfo.plotTypes.length;
            n++
          )
          ...
          for (n = 0; n < c.plotUnits.length; n++)
            if (
              c.plotUnits[n].axisYType === a.axisYType &&
              c.plotUnits[n].axisXType === a.axisXType &&
              c.plotUnits[n].axisYIndex === a.axisYIndex &&
              c.plotUnits[n].axisXIndex === a.axisXIndex
            ) {
              f = !0;
              e = c.plotUnits[n];
              break;
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          c = this.plotInfo.plotTypes[d], n = a = 0;
          n < c.plotUnits.length;
          n++
        )
          (c.plotUnits[n].previousDataSeriesCount = a),
            (a += c.plotUnits[n].dataSeriesIndexes.length);
    };
    ...
    l.prototype._processMultiseriesPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = 0;
          ...
          if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement)
            var p = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (m.dataPoints[A].x && m.dataPoints[A].x.getTime) ||
            "dateTime" === m.xValueType
          )
            f = !0;
          for (A = 0; A < m.dataPoints.length; A++) {
            "undefined" === typeof m.dataPoints[A].x &&
              (m.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0));
            m.dataPoints[A].x.getTime
              ? ((f = !0), (b = m.dataPoints[A].x.getTime()))
              : (b = m.dataPoints[A].x);
            e = m.dataPoints[A].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            ...
            if (0 < A) {
              if (a.axisX.logarithmic) {
                ...
                (C = b - m.dataPoints[A - 1].x),
                  0 > C && (C *= -1),
                  c.minDiff > C && 0 !== C && (c.minDiff = C);
              null !== e &&
                null !== m.dataPoints[A - 1].y &&
                (a.axisY.logarithmic
                  ? ((C = e / m.dataPoints[A - 1].y),
                    1 > C && (C = 1 / C),
                    d.minDiff > C && 1 !== C && (d.minDiff = C))
                  : ((C = e - m.dataPoints[A - 1].y),
                    0 > C && (C *= -1),
                    d.minDiff > C && 0 !== C && (d.minDiff = C)));
            }
            if (b < p && !h) null !== e && (q = b);
            else {
              if (!h && ((h = !0), 0 < A)) {
              ...
              if (b > g && !r) r = !0;
              else if (b > g && r) continue;
              m.dataPoints[A].label &&
                (a.axisX.labels[b] = m.dataPoints[A].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === e
                ? c.viewPortMin === b && q < b && (c.viewPortMin = q)
                : (e < d.viewPortMin &&
                    "number" === typeof e &&
                    (d.viewPortMin = e),
                  e > d.viewPortMax &&
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          if ("normal" === q.axisPlacement || "xySwapped" === q.axisPlacement)
            var da = a.axisX.sessionVariables.newViewportMinimum
                ? a.axisX.sessionVariables.newViewportMinimum
                : this.options.axisX && this.options.axisX.viewportMinimum
                ? this.options.axisX.viewportMinimum
                : this.options.axisX && this.options.axisX.minimum
              ...
              u = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (q.dataPoints[p].x && q.dataPoints[p].x.getTime) ||
            "dateTime" === q.xValueType
          )
            f = !0;
          for (p = 0; p < q.dataPoints.length; p++) {
            "undefined" === typeof q.dataPoints[p].x &&
              (q.dataPoints[p].x = p + (a.axisX.logarithmic ? 1 : 0));
            q.dataPoints[p].x.getTime
              ? ((f = !0), (b = q.dataPoints[p].x.getTime()))
              : (b = q.dataPoints[p].x);
            ...
            if (0 < p) {
              if (a.axisX.logarithmic) {
                ...
                (l = b - q.dataPoints[p - 1].x),
                  0 > l && (l *= -1),
                  c.minDiff > l && 0 !== l && (c.minDiff = l);
              null !== e &&
                null !== q.dataPoints[p - 1].y &&
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((l = e / q.dataPoints[p - 1].y),
                    1 > l && (l = 1 / l),
            ...
            if (b < da && !g) null !== q.dataPoints[p].y && (k = b);
            else {
              if (!g && ((g = !0), 0 < p)) {
                p -= 2;
                continue;
              ...
              if (b > u && !C) C = !0;
              else if (b > u && C) continue;
              q.dataPoints[p].label &&
                (a.axisX.labels[b] = q.dataPoints[p].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === q.dataPoints[p].y
                ? c.viewPortMin === b && k < b && (c.viewPortMin = k)
                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e),
                  0 <= e
                    ? n[b]
                      ? (n[b] += e)
                      : ((n[b] = e), (A = Math.min(e, A)))
                    : m[b]
                    ? (m[b] += e)
                    : ((m[b] = e), (h = Math.max(e, h))));
            }
          }
          a.axisY.scaleBreaks &&
            ...
            (d.dataPointYPositiveSums
              ...
              : ((d.dataPointYPositiveSums = n),
                (d.dataPointYNegativeSums = m)));
        ...
        for (p in n)
          n.hasOwnProperty(p) &&
            ...
            p < c.viewPortMin ||
              p > c.viewPortMax ||
              (a < d.viewPortMin && (d.viewPortMin = Math.min(a, A)),
        ...
        for (
          ...
          for (q = 0; q < r.dataPoints.length; q++) {
            ...
            r.dataPoints[q].x.getTime
              ? ((f = !0), (b = r.dataPoints[q].x.getTime()))
              : (b = r.dataPoints[q].x);
            ...
            if (b < k && !p) null !== e && (C = b);
              ...
              r.dataPoints[q].label &&
                (a.axisX.labels[b] = r.dataPoints[q].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === e
                ? c.viewPortMin === b && C < b && (c.viewPortMin = C)
                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e),
                  0 <= e ? (n = !0) : 0 > e && (m = !0),
          ...
          if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement)
            var l = a.axisX.sessionVariables.newViewportMinimum
              ...
              u = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (h.dataPoints[r].x && h.dataPoints[r].x.getTime) ||
            "dateTime" === h.xValueType
          )
            m = !0;
          for (r = 0; r < h.dataPoints.length; r++) {
            "undefined" === typeof h.dataPoints[r].x &&
              (h.dataPoints[r].x = r + (a.axisX.logarithmic ? 1 : 0));
            h.dataPoints[r].x.getTime
              ? ((m = !0), (b = h.dataPoints[r].x.getTime()))
              : (b = h.dataPoints[r].x);
            ...
            0 < r &&
              ...
              e &&
                null !== e[0] &&
                h.dataPoints[r - 1].y &&
                null !== h.dataPoints[r - 1].y[0] &&
                (a.axisY.logarithmic
                  ? ((C = e[0] / h.dataPoints[r - 1].y[0]),
                    1 > C && (C = 1 / C),
                    d.minDiff > C && 1 !== C && (d.minDiff = C))
                  : ((C = e[0] - h.dataPoints[r - 1].y[0]),
                    0 > C && (C *= -1),
            ...
            if (!(b < l) || q) {
              ...
              if (b > u && !p) p = !0;
              else if (b > u && p) continue;
              h.dataPoints[r].label &&
                (a.axisX.labels[b] = h.dataPoints[r].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              ...
              null === e
                ...
                : (f < d.viewPortMin && (d.viewPortMin = f),
                  n > d.viewPortMax && (d.viewPortMax = n));
            }
          }
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            f = !0;
          for (A = 0; A < m.dataPoints.length; A++)
            "undefined" !== typeof m.dataPoints[A].isCumulativeSum &&
            !0 === m.dataPoints[A].isCumulativeSum
              ? ((m.dataPointEOs[A].cumulativeSumYStartValue = 0),
                (m.dataPointEOs[A].cumulativeSum =
                  0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum),
                (m.dataPoints[A].y =
                  0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum))
              : "undefined" !== typeof m.dataPoints[A].isIntermediateSum &&
                !0 === m.dataPoints[A].isIntermediateSum
              ? ((m.dataPointEOs[A].cumulativeSumYStartValue = q),
                (m.dataPointEOs[A].cumulativeSum =
                  0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum),
                (m.dataPoints[A].y = 0 === A ? 0 : b),
                (q = 0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum),
                (b = 0))
              : ((e =
                  "number" !== typeof m.dataPoints[A].y
                    ? 0
                    : m.dataPoints[A].y),
                (m.dataPointEOs[A].cumulativeSumYStartValue =
                  0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum),
                (m.dataPointEOs[A].cumulativeSum =
                  0 === A ? e : m.dataPointEOs[A - 1].cumulativeSum + e),
                (b += e));
          for (A = 0; A < m.dataPoints.length; A++)
            if (
              ("undefined" === typeof m.dataPoints[A].x &&
              ...
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              m.dataPointEOs[A].cumulativeSum < d.min &&
                (d.min = m.dataPointEOs[A].cumulativeSum),
              m.dataPointEOs[A].cumulativeSum > d.max &&
                (d.max = m.dataPointEOs[A].cumulativeSum),
              0 < A &&
                (a.axisX.logarithmic
                  ? ((q = b / m.dataPoints[A - 1].x),
                    1 > q && (q = 1 / q),
                    c.minDiff > q && 1 !== q && (c.minDiff = q))
                  : ((q = b - m.dataPoints[A - 1].x),
                    0 > q && (q *= -1),
                ...
                null !== e &&
                  ...
                  (a.axisY.logarithmic
                    ? ((e =
                        m.dataPointEOs[A].cumulativeSum /
                        m.dataPointEOs[A - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < A &&
                (m.dataPointEOs[A - 1].cumulativeSum < d.viewPortMin &&
                  (d.viewPortMin = m.dataPointEOs[A - 1].cumulativeSum),
                m.dataPointEOs[A - 1].cumulativeSum > d.viewPortMax &&
                  (d.viewPortMax = m.dataPointEOs[A - 1].cumulativeSum));
              m.dataPointEOs[A].cumulativeSum < d.viewPortMin &&
                (d.viewPortMin = m.dataPointEOs[A].cumulativeSum);
              m.dataPointEOs[A].cumulativeSum > d.viewPortMax &&
                (d.viewPortMax = m.dataPointEOs[A].cumulativeSum);
            }
          m.axisX.valueType = m.xValueType = f ? "dateTime" : "number";
        }
    };
    l.prototype.calculateAutoBreaks = function () {
                  ...
                  if (
                    (b &&
                      ((p =
                        ...
                        100),
                      (g = k.dataPoints[q].x.getTime
                        ? k.dataPoints[q].x.getTime()
                        : k.dataPoints[q].x),
                      (p = Math.floor((g - h) / p)),
                      g < f[p].min && (f[p].min = g),
                      g > f[p].max && (f[p].max = g)),
                    ...
                    if (
                      (g =
                        "waterfall" === a.type
                          ? k.dataPointEOs[q].cumulativeSum
                          : k.dataPoints[q].y) &&
                      g.length
                    )
                      for (var t = 0; t < g.length; t++)
                        (p = Math.floor((g[t] - m) / l)),
                          g[t] < d[p].min && (d[p].min = g[t]),
                          g[t] > d[p].max && (d[p].max = g[t]);
                    else
                      s(g) ||
                        ((p = Math.floor((g - m) / l)),
                        g < d[p].min && (d[p].min = g),
      ...
      for (var b, e = this, f = !1, n = 0; n < this._axes.length; n++)
        if (
          this._axes[n].scaleBreaks &&
          this._axes[n].scaleBreaks.autoCalculate &&
          1 <= this._axes[n].scaleBreaks.maxNumberOfAutoBreaks
        ) {
          f = !0;
          ...
          for (
            ...
            100 /
              Math.max(
                parseFloat(this._axes[n].scaleBreaks.collapsibleThreshold) ||
                  10,
                10
              );
            m++
      ...
      if (f) {
        for (n = 0; n < this.plotInfo.plotTypes.length; n++)
          for (
            f = this.plotInfo.plotTypes[n], m = 0;
        ...
        for (n = 0; n < this._axes.length; n++)
          if (this._axes[n].dataInfo._dataRanges) {
            ...
            for (m = 0; m < h.length - 1; m++)
              if (((r = h[m].max), isFinite(r)))
                for (; m < h.length - 1; )
                  if (((A = h[m + 1].min), isFinite(A))) {
                    q = A - r;
                    q > b && f.push({ diff: q, start: r, end: A });
                    break;
                  } else m++;
            if (this._axes[n].scaleBreaks.customBreaks)
              for (
                m = 0;
                m < this._axes[n].scaleBreaks.customBreaks.length;
                m++
              )
                for (b = 0; b < f.length; b++)
                  if (
                    (this._axes[n].scaleBreaks.customBreaks[m].startValue <=
                      f[b].start &&
                      f[b].start <=
                        this._axes[n].scaleBreaks.customBreaks[m].endValue) ||
                    (this._axes[n].scaleBreaks.customBreaks[m].startValue <=
                      f[b].start &&
                      f[b].start <=
                        this._axes[n].scaleBreaks.customBreaks[m].endValue) ||
            ...
            for (
              ...
              Math.min(
                f.length,
                this._axes[n].scaleBreaks.maxNumberOfAutoBreaks
              );
              m++
            )
              (b = a(
                f[m].start,
                f[m].end,
                this._axes[n].logarithmic
                  ? this._axes[n].dataInfo.max / this._axes[n].dataInfo.min
                  : this._axes[n].dataInfo.max - this._axes[n].dataInfo.min,
                this._axes[n].logarithmic
              )),
                this._axes[n].scaleBreaks.autoBreaks.push(
                  new U(
                    this,
                    "autoBreaks",
                    b,
                ...
                this._axes[n].scaleBreaks._appliedBreaks.push(
                  this._axes[n].scaleBreaks.autoBreaks[
                    this._axes[n].scaleBreaks.autoBreaks.length - 1
                  ]
                );
    ...
    l.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      for (c = 0; c < b.length; c++)
        if (
          ...
          if (
            ((e = la("markerSize", b[c].dataPoint, b[c].dataSeries) || 8),
            b[c].distance <= e / 2)
          ) {
            d = !0;
            break;
    ...
    l.prototype.getObjectAtXY = function (a, d, c) {
      ...
      else if (t) b = Za(a, d, this._eventManager.ghostCtx);
      else
      ...
      if (a.changedTouches && this.interactivityEnabled) {
        ...
        if (!(c && 1 < c.length)) {
          ...
          try {
            ...
            if (
              (1 < Math.abs(n) && this._lastTouchData.scroll) ||
              (5 < Math.abs(n) && 250 > f)
            )
        ...
        if (this.axisX && 0 < this.axisX.length)
          for (n = 0; n < this.axisX.length; n++)
            this.axisX[n].crosshair &&
              this.axisX[n].crosshair.enabled &&
              this.axisX[n].renderCrosshair(a, d);
        if (this.axisX2 && 0 < this.axisX2.length)
          for (n = 0; n < this.axisX2.length; n++)
            this.axisX2[n].crosshair &&
              this.axisX2[n].crosshair.enabled &&
              this.axisX2[n].renderCrosshair(a, d);
        if (this.axisY && 0 < this.axisY.length)
          for (n = 0; n < this.axisY.length; n++)
            this.axisY[n].crosshair &&
              this.axisY[n].crosshair.enabled &&
              this.axisY[n].renderCrosshair(a, d);
        if (this.axisY2 && 0 < this.axisY2.length)
          for (n = 0; n < this.axisY2.length; n++)
            this.axisY2[n].crosshair &&
              this.axisY2[n].crosshair.enabled &&
              this.axisY2[n].renderCrosshair(a, d);
      }
    };
        ...
        if (
          ...
          if (this.panEnabled)
            (e = {
              ...
              clearTimeout(n._panTimerId),
              (n._panTimerId = setTimeout(
                (function (b, c, e, f) {
                  return function () {
                    n._zoomPanToSelectedRegion(b, c, e, f, !0) &&
                      (n._dispatchRangeEvent("rangeChanging", "pan"),
                      n.stockChart &&
                        n.stockChart.navigator &&
                        n.stockChart.navigator.enabled &&
                        ((n.stockChart._rangeEventParameter.type =
                          "rangeChanging"),
                        n.stockChart.dispatchEvent(
                          "rangeChanging",
                          n.stockChart._rangeEventParameter,
                          n.stockChart
                        )),
                      n.render(),
    ...
    l.prototype.validateRegion = function (a, d, c, b, e) {
      ...
      for (
        ...
        (("axisX" === this._axes[q].type && f) ||
          ("axisY" === this._axes[q].type && n)) &&
          h.push(this._axes[q]);
      for (n = 0; n < h.length; n++) {
        var q = h[n],
          f = !1,
          p = q.convertPixelToValue({ x: a, y: d }),
          g = q.convertPixelToValue({ x: c, y: b });
        if (p > g)
          var C = g,
            g = p,
            p = C;
        if (q.scaleBreaks)
          for (C = 0; !f && C < q.scaleBreaks._appliedBreaks.length; C++)
            f =
              q.scaleBreaks._appliedBreaks[C].startValue <= p &&
              q.scaleBreaks._appliedBreaks[C].endValue >= g;
        if (isFinite(q.dataInfo.minDiff))
          if (
            ((C = q.getApparentDifference(p, g, null, !0)),
            !(
              f ||
              (!(
                this.panEnabled &&
                ...
                ((q.logarithmic && C < Math.pow(q.dataInfo.minDiff, 3)) ||
                  (!q.logarithmic && C < 3 * Math.abs(q.dataInfo.minDiff)))) ||
              p < q.minimum ||
              g > q.maximum
            ))
          )
            A.push(q), r.push({ val1: p, val2: g }), (m = !0);
          else if (!e) {
            m = !1;
            break;
          }
      }
      return { isValid: m, axesWithValidRange: A, axesRanges: r };
    };
    ...
    l.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        var n = la("indexLabelFontWeight", h.dataPoint, h.dataSeries),
          ...
          l = s(h.dataPoint.indexLabelLineThickness)
            ? s(h.dataSeries.options.indexLabelLineThickness)
              ? 0
        ...
        if (
          ...
          u = this.getPercentAndTotal(h.dataSeries, h.dataPoint);
        ...
        var z = h.dataPoint.indexLabelFormatter
          ? h.dataPoint.indexLabelFormatter(x)
          ...
          ? h.dataSeries.indexLabelFormatter(x)
        ...
        if (null !== z && "" !== z) {
          ...
          if ("stackedarea100" === r) {
            ...
            if (
              ...
              Math.max.apply(null, h.dataPoint.y) < B.viewportMinimum ||
              Math.min.apply(null, h.dataPoint.y) > B.viewportMaximum
            )
              continue;
          } else if (
            0 <= r.indexOf("line") ||
            ...
            if (
              h.dataPoint.x < y.viewportMinimum ||
              h.dataPoint.x > y.viewportMaximum ||
              h.dataPoint.y < B.viewportMinimum ||
              h.dataPoint.y > B.viewportMaximum
            )
              continue;
          } else if (
            0 <= r.indexOf("column") ||
            "waterfall" === r ||
            ("error" === r && !h.axisSwapped)
          ) {
            if (
              h.dataPoint.x < y.viewportMinimum ||
              h.dataPoint.x > y.viewportMaximum ||
          ...
          e = n = 2;
          "horizontal" === x
            ? ((m = g.width), (A = g.height))
            : ((A = g.width), (m = g.height));
                ...
                0 < D
                  ...
                  : ((p = h.point.y + n + b),
                    p > f - A - n - b &&
                      ((p =
                        "auto" === u
                          ? Math.min(h.point.y, f) - A - n - b
                          : f - A - n - b),
                      (v = p < h.point.y))))
              : ((e = Math.max(h.bounds.y1, c.y1)),
                (f = Math.min(h.bounds.y2, c.y2)),
                (b =
                  0 <= r.indexOf("range") || "error" === r
                    ? 0 < D
                      ? Math.max(h.bounds.y1, c.y1) + A / 2 + n
                      : Math.min(h.bounds.y2, c.y2) - A / 2 - n
                    : (Math.max(h.bounds.y1, c.y1) +
                        Math.min(h.bounds.y2, c.y2)) /
                      2),
                0 < D
                  ? ((p = Math.max(h.point.y, b) - A / 2),
                    p < e &&
                      ("bubble" === r || "scatter" === r) &&
                      (p = Math.max(h.point.y - A - n, c.y1 + n)))
                  : ((p = Math.min(h.point.y, b) - A / 2),
                    p > f - A - n &&
                      ("bubble" === r || "scatter" === r) &&
                      (p = Math.min(h.point.y + n, c.y2 - A - n))),
                (p = Math.min(p, f - A)));
          } else
            0 <= r.indexOf("line") ||
            0 <= r.indexOf("area") ||
                  ...
                  0 > D
                    ...
                    : ((q = h.point.x + e + b),
                      q > f - m - e - b &&
                        ((q =
                          "auto" === u
                            ? Math.min(h.point.x, f) - m - e - b
                            : f - m - e - b),
                        (v = q < h.point.x))))
                : ((n = Math.max(h.bounds.x1, c.x1)),
                  Math.min(h.bounds.x2, c.x2),
                  (b =
                    0 <= r.indexOf("range") || "error" === r
                      ? 0 > D
                        ? Math.max(h.bounds.x1, c.x1) + m / 2 + e
                        : Math.min(h.bounds.x2, c.x2) - m / 2 - e
                      : (Math.max(h.bounds.x1, c.x1) +
                          Math.min(h.bounds.x2, c.x2)) /
                        2),
                  (q =
                    0 > D
                      ? Math.max(h.point.x, b) - m / 2
                      : Math.min(h.point.x, b) - m / 2),
                  (q = Math.max(q, n)));
          "vertical" === x && (p += A);
          g.x = q;
          g.y = p;
          ...
          l &&
            ...
            d.setLineDash && d.setLineDash(N(C, l)),
            d.beginPath(),
            d.moveTo(h.point.x, h.point.y),
            0 <= r.indexOf("bar") || ("error" === r && h.axisSwapped)
              ? d.lineTo(
                  q + (0 < h.direction ? 0 : m),
                  p + ("horizontal" === x ? A : -A) / 2
                )
              : 0 <= r.indexOf("column") || ("error" === r && !h.axisSwapped)
              ? d.lineTo(
                  q + m / 2,
                  p +
                    ((0 < h.direction ? A : -A) +
              ...
              : d.lineTo(
                  q + m / 2,
                  p +
                    ((p < h.point.y ? A : -A) + ("horizontal" === x ? A : -A)) /
                      2
                ),
            d.stroke());
        }
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (h = this._indexLabels[a]),
          (g = la("indexLabelBackgroundColor", h.dataPoint, h.dataSeries)),
          (h.dataSeries.indexLabelBackgroundColor = s(g)
            ? t
              ? "transparent"
              : null
            : g);
    ...
    l.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], n, m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          var C = h._colorSet,
            k = (C = h.lineColor = h.options.lineColor
              ? h.options.lineColor
              : C[0]);
          c.strokeStyle = C;
          var l = !0,
          ...
          if (0 < r.length) {
            for (var D = !1, u = 0; u < r.length; u++)
              if (
                ((x = r[u].x.getTime ? r[u].x.getTime() : r[u].x),
                !(
                  ...
                  l || D
                    ...
                    : (c.lineTo(x, s),
                      ...
                      0 == u % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(x, s),
                        t && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                  n = { x: x, y: s };
                  u < r.length - 1 &&
                    (k !== (r[u].lineColor || C) ||
                      q !== (r[u].lineDashType || h.lineDashType)) &&
                    (c.stroke(),
                    c.beginPath(),
                    c.moveTo(x, s),
                    (k = r[u].lineColor || C),
                    ...
                    c.setLineDash &&
                      (r[u].lineDashType
                        ? ((q = r[u].lineDashType),
                          c.setLineDash(N(q, h.lineThickness)))
                        : ((q = h.lineDashType), c.setLineDash(g))));
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], n, m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < r.length) {
            for (var D = !1, u = 0; u < r.length; u++)
              if (
                ((x = r[u].getTime ? r[u].x.getTime() : r[u].x),
                !(
                  x < a.axisX.dataInfo.viewPortMin ||
                  (x > a.axisX.dataInfo.viewPortMax &&
                    (!h.connectNullData || !D))
                  ...
                  u < r.length - 1 &&
                    ...
                    c.setLineDash &&
                      (r[u].lineDashType
                        ...
                        : ((q = h.lineDashType), c.setLineDash(g))));
                  if (0 < r[u].markerSize || 0 < h.markerSize)
                    (y = h.getMarkerProperties(u, x, s, c)),
                      f.push(y),
                      (B = Q(B)),
                      t &&
                        f.push({
        ...
        for (var n = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < r.length)
            for (s = !1, l = 0; l < r.length; l++)
              if (
                ((u = r[l].getTime ? r[l].x.getTime() : r[l].x),
                !(
                ...
                if ("number" !== typeof r[l].y)
                  0 < l &&
                    ...
                    (h.connectNullData
                      ? b.setLineDash &&
                        ...
                        (h.options.nullDataLineDashType ||
                          !r[l - 1].lineDashType) &&
                        ((z[z.length - 1].newLineDashArray = p),
                        (q = h.nullDataLineDashType))
                      : (d(z), (z = []))),
                    (s = !0);
                else {
                  ...
                  l < r.length - 1 &&
                    (k !== (r[l].lineColor || C) ||
                      q !== (r[l].lineDashType || h.lineDashType)) &&
                    ((k = r[l].lineColor || C),
                    (z[z.length - 1].newStrokeStyle = k),
                    b.setLineDash &&
                      (r[l].lineDashType
                        ? ((q = r[l].lineDashType),
    ...
    l.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < C.length)
            for (
              var k = 5 < q && g.bevelEnabled ? !0 : !1, f = 0;
              f < C.length;
              f++
            )
              if (
                (C[f].getTime ? (A = C[f].x.getTime()) : (A = C[f].x),
                !(
                  A < a.axisX.dataInfo.viewPortMin ||
                  A > a.axisX.dataInfo.viewPortMax
                ) && "number" === typeof C[f].y)
              ) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        g = this.options.dataPointWidth
          ...
          : (0.9 *
              ((e.width *
                (a.axisX.logarithmic
                  ? Math.log(g) / Math.log(a.axisX.range)
                  : Math.abs(g) / Math.abs(a.axisX.range))) /
        ...
        for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          if (0 < u.length) {
            ...
            for (h = 0; h < u.length; h++)
              if (
                ((b = u[h].x.getTime ? u[h].x.getTime() : u[h].x),
                !(
                ...
                var z =
                    (r - (a.plotType.plotUnits.length * g) / 2 + a.index * g) <<
                    0,
                  D = (z + g) << 0,
                  y;
                if (
                  ...
                  (A[b] = u[h].y + (A[b] ? A[b] : 0)),
                    (y = a.axisY.convertValueToPixel(A[b])),
                    (q = "undefined" !== typeof n[b] ? n[b] : p),
                    (n[b] = y);
                else if (
                  ((q = a.axisY.convertValueToPixel(u[h].y)), 0 <= u[h].y)
                ) {
                ...
                b = u[h].color
                  ? u[h].color
                  : l._colorSet[h % l._colorSet.length];
                ba(
                  c,
                  z,
                  q,
    ...
    l.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          if (0 < u.length)
            for (
              var s = 5 < g && l.bevelEnabled ? !0 : !1, h = 0;
              h < u.length;
              h++
            )
              if (
                ...
                if (
                  ...
                  (A[b] = q + ("undefined" !== typeof A[b] ? A[b] : 0)),
                    (y = a.axisY.convertValueToPixel(A[b])),
                    (q = n[b] ? n[b] : p),
                    (n[b] = y);
                else if (((q = a.axisY.convertValueToPixel(q)), 0 <= u[h].y)) {
                  var B = "undefined" !== typeof f[b] ? f[b] : 0;
                  q -= B;
                  y = p - B;
                  a.dataSeriesIndexes.length - 1 === C &&
                    1 >= Math.abs(e.y1 - q) &&
                    (q = e.y1);
                  f[b] = B + (y - q);
                } else
                  (B = "undefined" !== typeof n[b] ? n[b] : 0),
                    (y = q + B),
                    (q = p + B),
                    a.dataSeriesIndexes.length - 1 === C &&
                      1 >= Math.abs(e.y2 - y) &&
          ...
          if (0 < u.length) {
            ...
            for (h = 0; h < u.length; h++)
              if (
                ...
                var z =
                    (q - (a.plotType.plotUnits.length * g) / 2 + a.index * g) <<
                    0,
                  D = (z + g) << 0,
                  y;
                if (
                  ...
                  (A[b] = u[h].y + (A[b] ? A[b] : 0)),
                    (r = n[b] ? n[b] : p),
                    (n[b] = y = a.axisY.convertValueToPixel(A[b]));
                else if (
                  ((r = a.axisY.convertValueToPixel(u[h].y)), 0 <= u[h].y)
                ) {
                  var B = f[b] ? f[b] : 0;
                  y = p + B;
                  r += B;
            ...
            for (h = 0; h < u.length; h++)
              if (
                ...
                if (
                  ...
                  (A[b] = z + (A[b] ? A[b] : 0)),
                    (r = n[b] ? n[b] : p),
                    (n[b] = z = a.axisY.convertValueToPixel(A[b]));
                else if (((r = a.axisY.convertValueToPixel(z)), 0 <= u[h].y)) {
                  var B = f[b] ? f[b] : 0;
                  z = p + B;
                  r += B;
                  a.dataSeriesIndexes.length - 1 === C &&
    ...
    l.prototype.renderArea = function (a) {
      ...
      function b() {
        y &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          t && (n.lineTo(l, D), n.lineTo(y.x, D), n.closePath(), n.fill()),
          f.beginPath(),
          f.moveTo(l, u),
          n.beginPath(),
          n.moveTo(l, u),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          ...
          if (0 < C.length) {
            ...
            for (var ka = !0; k < C.length; k++)
              if (
                ((s = C[k].x.getTime ? C[k].x.getTime() : C[k].x),
                !(
                  s < a.axisX.dataInfo.viewPortMin ||
                  (s > a.axisX.dataInfo.viewPortMax &&
                    (!g.connectNullData || !ka))
                ))
              )
                if ("number" !== typeof C[k].y)
                  g.connectNullData || ka || d || b(), (ka = !0);
                else {
                  ...
                  k < C.length - 1 &&
                    (w !== (C[k].lineColor || v) ||
                      c !== (C[k].lineDashType || g.lineDashType)) &&
                    (b(),
                    (w = C[k].lineColor || v),
                    (f.strokeStyle = w),
                    f.setLineDash &&
                  ...
                  0 !== C[k].markerSize &&
                    (0 < C[k].markerSize || 0 < g.markerSize) &&
                    ((s = g.getMarkerProperties(k, l, u, f)),
                    A.push(s),
                    (Z = Q(Z)),
                    t &&
                      A.push({
        ...
        t &&
          ...
          f.clearRect(h.x1, h.y1, h.width, h.height),
          this._eventManager.ghostCtx.restore());
        f.restore();
        return {
          source: e,
        ...
        for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          if (0 < q.length) {
            ...
            for (C = !1; p < q.length; p++)
              if (
                ((g = q[p].x.getTime ? q[p].x.getTime() : q[p].x),
                !(
                ...
                if ("number" !== typeof q[p].y)
                    ...
                    (r.connectNullData
                      ? b.setLineDash &&
                        ...
                        (r.options.nullDataLineDashType ||
                          !q[p - 1].lineDashType) &&
                        ((s[s.length - 1].newLineDashArray = w),
                  ...
                  p < q.length - 1 &&
                    (y !== (q[p].lineColor || D) ||
                      B !== (q[p].lineDashType || r.lineDashType)) &&
                    ((y = q[p].lineColor || D),
                    (s[s.length - 1].newStrokeStyle = y),
                    b.setLineDash &&
                      (q[p].lineDashType
                        ? ((B = q[p].lineDashType),
                        ...
                        : ((B = r.lineDashType),
                          (s[s.length - 1].newLineDashArray = E))));
                  if (
                    0 !== q[p].markerSize &&
                    (0 < q[p].markerSize || 0 < r.markerSize)
                  ) {
              ...
              if (
                ...
                "number" !== typeof C[k].y
                  ...
                  : ((l = a.axisX.convertValueToPixel(s)),
                    ...
                    d || c
                      ? (!d && g.connectNullData
                          ? (f.setLineDash &&
                              ...
                              (u = c),
                              (y = r),
                              (T = g.nullDataLineDashType),
                              f.setLineDash(S)),
                            f.lineTo(l, Z),
                            f.lineTo(l, u),
                            t && (n.lineTo(l, Z), n.lineTo(l, u)))
                          : (f.beginPath(),
                            f.moveTo(l, u),
                            t && (n.beginPath(), n.moveTo(l, u)),
                            (y = { x: l, y: u })),
                    ...
                    k < C.length - 1 &&
                      (w !== (C[k].lineColor || v) ||
                        T !== (C[k].lineDashType || g.lineDashType)) &&
                      (b(),
                      (w = C[k].lineColor || v),
                      (f.strokeStyle = w),
                      f.setLineDash &&
                        (C[k].lineDashType
                          ? ((T = C[k].lineDashType),
                            f.setLineDash(N(T, g.lineThickness)))
                          : ((T = g.lineDashType), f.setLineDash(E)))),
                    (s = g.dataPointIds[k]),
                    ...
                    0 !== C[k].markerSize &&
                      (0 < C[k].markerSize || 0 < g.markerSize) &&
                      ((Z = g.getMarkerProperties(k, l, u, f)),
                      A.push(Z),
                      (s = Q(s)),
                      t &&
                        A.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], D = 0; D < a.dataSeriesIndexes.length; D++) {
          ...
          for (p = 0; p < v.length; p++)
            (y = v[p].x.getTime ? v[p].x.getTime() : v[p].x),
              (B.dataPointIndexes[y] = p),
              e[y] || (r.push(y), (e[y] = !0));
          r.sort(Qa);
        }
            ...
            for (var Z = !0, p = 0; p < r.length; p++) {
              ...
              if (
                ...
                if ("number" !== typeof ga.y)
                  ...
                  x || Z
                    ? (!x && B.connectNullData
                        ? (b.setLineDash &&
                            ...
                            h.push(z),
                            h.push(x),
                            (z = B.nullDataLineDashType),
                            b.setLineDash(S)),
                          b.lineTo(g, k),
                          t && s.lineTo(g, k))
                        : (b.beginPath(),
                          b.moveTo(g, k),
                          t && (s.beginPath(), s.moveTo(g, k))),
                      (Z = x = !1))
                    : (b.lineTo(g, k),
                      t && s.lineTo(g, k),
                      0 == p % 250 &&
                  ...
                  p < v.length - 1 &&
                    (T !== (v[p].lineColor || w) ||
                      z !== (v[p].lineDashType || B.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, k),
                    h.push({ x: g, y: l - ma }),
                    ...
                    b.setLineDash &&
                      (v[p].lineDashType
                        ? ((z = v[p].lineDashType),
                          b.setLineDash(N(z, B.lineThickness)))
                        : ((z = B.lineDashType), b.setLineDash(E))));
                  ...
                  0 <= B.dataPointIndexes[f] &&
                    0 !== ga.markerSize &&
                    (0 < ga.markerSize || 0 < B.markerSize) &&
                    ((ma = B.getMarkerProperties(
                      B.dataPointIndexes[f],
                      g,
                      k,
                      b
                    )),
            ...
            for (var Z = !0, p = 0; p < r.length; p++) {
              ...
              if (
                ...
                if ("number" !== typeof ga.y)
                  ...
                  da || Z
                    ? (!da && B.connectNullData
                        ? (b.setLineDash &&
                            ...
                            h.push(u),
                            h.push(da),
                            (u = B.nullDataLineDashType),
                            b.setLineDash(S)),
                          b.lineTo(g, l),
                          t && z.lineTo(g, l))
                        : (b.beginPath(),
                          b.moveTo(g, l),
                          t && (z.beginPath(), z.moveTo(g, l))),
                      (Z = da = !1))
                    : (b.lineTo(g, l),
                      t && z.lineTo(g, l),
                      0 == p % 250 &&
                  ...
                  p < v.length - 1 &&
                    (T !== (v[p].lineColor || w) ||
                      u !== (v[p].lineDashType || B.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, l),
                    h.push({ x: g, y: x - F }),
                    ...
                    b.setLineDash &&
                      (v[p].lineDashType
                        ? ((u = v[p].lineDashType),
                          b.setLineDash(N(u, B.lineThickness)))
                        : ((u = B.lineDashType), b.setLineDash(E))));
                  if (0 <= B.dataPointIndexes[f]) {
                  ...
                  0 <= B.dataPointIndexes[f] &&
                    0 !== ga.markerSize &&
                    (0 < ga.markerSize || 0 < B.markerSize) &&
                    ((F = B.getMarkerProperties(p, g, l, b)),
                    m.push(F),
                    (f = Q(G)),
                    t &&
                      m.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          for (
            ...
            (f = p[e].getTime ? (f = p[e].x.getTime()) : (f = p[e].x)),
              f < a.axisX.dataInfo.viewPortMin ||
                f > a.axisX.dataInfo.viewPortMax ||
                "undefined" === typeof p[e].z ||
                ((g = p[e].z), g > m && (m = g), g < k && (k = g));
        for (
          var l = 25 * Math.PI,
            s = Math.max(
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < r.length) {
            ...
            for (var q = 0, p = 0, e = 0; e < r.length; e++)
              if (
                ((f = r[e].getTime ? (f = r[e].x.getTime()) : (f = r[e].x)),
                !(
                  f < a.axisX.dataInfo.viewPortMin ||
                  f > a.axisX.dataInfo.viewPortMax
                ) && "number" === typeof r[e].y)
    ...
    l.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var fa = 0; fa < a.dataSeriesIndexes.length; fa++) {
          ...
          if (0 < x.length)
            for (
              var z = 5 < l && u.bevelEnabled ? !0 : !1, m = 0;
              m < x.length;
              m++
            )
              if (
                (x[m].getTime ? (g = x[m].x.getTime()) : (g = x[m].x),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) &&
                ...
                "candlestick" === u.type
                  ? (c.moveTo(k - w, r),
                    c.lineTo(k - w, Math.min(h, p)),
                    c.stroke(),
                    c.moveTo(k - w, Math.max(h, p)),
                    c.lineTo(k - w, q),
                    c.stroke(),
                    ba(
                      c,
                      ...
                      y,
                      Math.max(h, p),
                      x[m].y[0] <= x[m].y[3] ? u.risingColor : f,
                      B,
                      e,
                      z,
                      z,
                    ...
                    t &&
                      ...
                      (b.strokeStyle = e),
                      b.moveTo(k - w, r),
                      b.lineTo(k - w, Math.min(h, p)),
                      b.stroke(),
                      b.moveTo(k - w, Math.max(h, p)),
                      b.lineTo(k - w, q),
                      b.stroke(),
                      ba(
                        b,
                ...
                (x[m].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: x[m],
                    dataSeries: u,
                    point: { x: v + (y - v) / 2, y: a.axisY.reversed ? q : r },
                    direction: 1,
                    bounds: {
                      x1: v,
                      y1: Math.min(r, q),
    ...
    l.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var fa = !1, fa = !!a.axisY.reversed, da = 0;
          da < a.dataSeriesIndexes.length;
          da++
        ) {
          ...
          if (0 < z.length)
            for (
              var v = 5 < l && x.bevelEnabled ? !0 : !1, n = 0;
              n < z.length;
              n++
            )
              if (
                (z[n].getTime ? (g = z[n].x.getTime()) : (g = z[n].x),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) &&
                  !s(z[n].y) &&
                  z[n].y.length &&
                  "number" === typeof z[n].y[0] &&
                  "number" === typeof z[n].y[1] &&
                  "number" === typeof z[n].y[2] &&
                  "number" === typeof z[n].y[3] &&
                  "number" === typeof z[n].y[4] &&
                  5 === z[n].y.length)
              ) {
                ...
                var y = (m - l / 2) << 0,
                  ...
                  T = z[n].whiskerColor
                    ...
                    : e,
                  S =
                    "number" === typeof z[n].whiskerThickness
                      ? z[n].whiskerThickness
                      : "number" === typeof x.options.whiskerThickness
                      ? x.whiskerThickness
                      : w,
                  F = z[n].whiskerDashType
                    ? z[n].whiskerDashType
                    : x.whiskerDashType,
                  Z = s(z[n].whiskerLength)
                    ? s(x.options.whiskerLength)
                      ? l
                      : x.whiskerLength
                    : z[n].whiskerLength,
                  Z =
                  ...
                  ma = z[n].stemColor
                    ...
                    : e,
                  Ba =
                    "number" === typeof z[n].stemThickness
                      ? z[n].stemThickness
                      : "number" === typeof x.options.stemThickness
                      ? x.stemThickness
                      : w,
                  ...
                  I = z[n].lineColor
                    ...
                    : e,
                  M =
                    "number" === typeof z[n].lineThickness
                      ? z[n].lineThickness
                      : "number" === typeof x.options.lineThickness
                      ? x.lineThickness
                      : w,
                ...
                0 < Ba &&
                  ...
                  (c.strokeStyle = ma),
                  (c.lineWidth = Ba),
                  c.setLineDash && c.setLineDash(N(J, Ba)),
                  c.moveTo(m - G, h),
                  c.lineTo(m - G, k),
                  c.stroke(),
                  c.moveTo(m - G, q),
                ...
                0 < M &&
                  (c.beginPath(),
                  (c.globalAlpha = 1),
                  c.setLineDash && c.setLineDash(N(R, M)),
                  (c.strokeStyle = I),
                  (c.lineWidth = M),
                  c.moveTo(y, p - K),
                  c.lineTo(B, p - K),
                ...
                0 < S &&
                  (c.beginPath(),
                  c.setLineDash && c.setLineDash(N(F, S)),
                  (c.strokeStyle = T),
                  (c.lineWidth = S),
                  c.moveTo((m - Z / 2) << 0, q - ga),
                  c.lineTo((m + Z / 2) << 0, q - ga),
                  c.stroke(),
                  c.moveTo((m - Z / 2) << 0, k + ga),
                  c.lineTo((m + Z / 2) << 0, k + ga),
                  c.stroke());
                c.restore();
                t &&
                  ((e = Q(O)),
                  ...
                  0 < Ba &&
                    (b.moveTo(m - E - G, h),
                    b.lineTo(m - E - G, Math.max(k, q)),
                    b.stroke(),
                    b.moveTo(m - E - G, Math.min(k, q)),
                    b.lineTo(m - E - G, r),
                    b.stroke()),
                  ba(
                    b,
                ...
                (z[n].indexLabel ||
                  x.indexLabel ||
                  z[n].indexLabelFormatter ||
                  x.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: x.type,
                    dataPoint: z[n],
                    dataSeries: x,
                    point: { x: y + (B - y) / 2, y: a.axisY.reversed ? k : q },
                    direction: 1,
                    bounds: {
                      x1: y,
                      y1: Math.min(k, q),
    ...
    l.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < g.length)
            for (
              var l = 5 < h && p.bevelEnabled ? !0 : !1, f = 0;
              f < g.length;
              f++
            )
              if (
                (g[f].getTime ? (k = g[f].x.getTime()) : (k = g[f].x),
                !(
                ...
                var fa = a.axisX.reversed
                    ? (b +
                        (a.plotType.totalDataSeries * h) / 2 -
                        (a.previousDataSeriesCount + r) * h) <<
                      0
                    : (b -
                        (a.plotType.totalDataSeries * h) / 2 +
                        (a.previousDataSeriesCount + r) * h) <<
    ...
    l.prototype.renderError = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        t &&
          (this._eventManager.ghostCtx.beginPath(),
          this._eventManager.ghostCtx.rect(n.x1, n.y1, n.width, n.height),
          this._eventManager.ghostCtx.clip());
        ...
        for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
          var z = a.dataSeriesIndexes[x],
            ...
            B = s(D._linkedSeries)
              ? !1
              : D._linkedSeries.type.match(/(bar|column)/gi) &&
                D._linkedSeries.visible
              ? !0
              : !1,
            E = 0;
          if (B)
            for (e = D._linkedSeries.id, u = 0; u < e; u++)
              !this.data[u].type.match(/(bar|column)/gi) ||
                !this.data[u].visible ||
          ...
          m = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (B ? v : 1))
              ) << 0
            : 0.3 * this.width;
          f &&
            (m = this.options.dataPointMaxWidth
          ...
          u = this.options.dataPointWidth
            ...
            : (0.9 *
                (((b ? n.height : n.width) *
                  (a.axisX.logarithmic
                    ? Math.log(fa) / Math.log(a.axisX.range)
                    : Math.abs(fa) / Math.abs(a.axisX.range))) /
                  (B ? v : 1))) <<
              0;
          this.dataPointMaxWidth &&
            e > m &&
          ...
          u > m && (u = m);
          if (0 < y.length)
            for (var F = D._colorSet, m = 0; m < y.length; m++) {
              var e = (D.lineColor = D.options.color ? D.options.color : F[0]),
                T = {
                  color: y[m].whiskerColor
                    ? y[m].whiskerColor
                    : y[m].color
                    ? D.whiskerColor
                      ? D.whiskerColor
                    ...
                    ? D.whiskerColor
                    : e,
                  thickness: s(y[m].whiskerThickness)
                    ? D.whiskerThickness
                    : y[m].whiskerThickness,
                  dashType: y[m].whiskerDashType
                    ? y[m].whiskerDashType
                    : D.whiskerDashType,
                  length: s(y[m].whiskerLength)
                    ? s(D.options.whiskerLength)
                      ? u
                      : D.options.whiskerLength
                    : y[m].whiskerLength,
                  trimLength: s(y[m].whiskerLength)
                    ? s(D.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              var S = {
                color: y[m].stemColor
                  ...
                  ? D.stemColor
                  : e,
                thickness: y[m].stemThickness
                  ? y[m].stemThickness
                  : D.stemThickness,
                dashType: y[m].stemDashType
                  ? y[m].stemDashType
                  : D.stemDashType,
              };
              S.thickness =
              ...
              if (
                ...
                !s(y[m].y) &&
                y[m].y.length &&
                "number" === typeof y[m].y[0] &&
                "number" === typeof y[m].y[1]
              ) {
                ...
                b
                  ? ((p = a.axisX.reversed
                      ? (h + ((B ? v : 1) * u) / 2 - (B ? E - 1 : 0) * u) << 0
                      : (h - ((B ? v : 1) * u) / 2 + (B ? E - 1 : 0) * u) << 0),
                    (g = a.axisX.reversed ? (p - u) << 0 : (p + u) << 0))
                  : ((r = a.axisX.reversed
                      ? (k + ((B ? v : 1) * u) / 2 - (B ? E - 1 : 0) * u) << 0
                      : (k - ((B ? v : 1) * u) / 2 + (B ? E - 1 : 0) * u) << 0),
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          ...
          if (0 < l.length) {
            ...
            for (f = 0; f < l.length; f++)
              if (
                (l[f].getTime ? (h = l[f].x.getTime()) : (h = l[f].x),
                !(
                  ...
                  !s(l[f].y) &&
                  l[f].y.length &&
                  "number" === typeof l[f].y[0] &&
                  "number" === typeof l[f].y[1])
              ) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < q.length) {
            ...
            for (var T = !0; g < q.length; g++)
              if (
                ((u = q[g].x.getTime ? q[g].x.getTime() : q[g].x),
                !(
                  u < a.axisX.dataInfo.viewPortMin ||
                  (u > a.axisX.dataInfo.viewPortMax &&
                    (!r.connectNullData || !T))
                ...
                if (
                  null !== q[g].y &&
                  q[g].y.length &&
                  "number" === typeof q[g].y[0] &&
                  "number" === typeof q[g].y[1]
                ) {
                  ...
                  p || T
                    ? (r.connectNullData && !p
                        ? (b.setLineDash &&
                            ...
                            ((k[k.length - 1].newLineDashArray = E),
                            (B = r.nullDataLineDashType),
                            b.setLineDash(w)),
                          b.lineTo(l, s),
                          t && e.lineTo(l, s),
                  ...
                  g < q.length - 1 &&
                    (y !== (q[g].lineColor || D) ||
                      B !== (q[g].lineDashType || r.lineDashType)) &&
                    (d(),
                    (y = q[g].lineColor || D),
                    (k[k.length - 1].newStrokeStyle = y),
                    (b.strokeStyle = y),
                    b.setLineDash &&
                      (q[g].lineDashType
                        ? ((B = q[g].lineDashType),
                          (k[k.length - 1].newLineDashArray = N(
                            B,
                            r.lineThickness
                          )),
                          b.setLineDash(k[k.length - 1].newLineDashArray))
                        : ((B = r.lineDashType),
                          (k[k.length - 1].newLineDashArray = E),
                          b.setLineDash(E))));
                  if (
                    0 !== q[g].markerSize &&
                    (0 < q[g].markerSize || 0 < r.markerSize)
                  ) {
                  ...
                  if (
                    ...
                    this._indexLabels.push({
                      ...
                      point: { x: l, y: s },
                      direction:
                        q[g].y[0] > q[g].y[1] === a.axisY.reversed ? -1 : 1,
                      color: z,
                    }),
                      this._indexLabels.push({
                        chartType: "rangeArea",
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < r.length) {
            ...
            for (g = !1; q < r.length; q++)
              if (
                ((p = r[q].x.getTime ? r[q].x.getTime() : r[q].x),
                !(
                ...
                if (
                  ...
                  s[s.length] = { x: p, y: g };
                  da[da.length] = { x: p, y: l };
                  q < r.length - 1 &&
                    (z !== (r[q].lineColor || x) ||
                      D !== (r[q].lineDashType || h.lineDashType)) &&
                    ((z = r[q].lineColor || x),
                  ...
                  if (
                    0 !== r[q].markerSize &&
                    (0 < r[q].markerSize || 0 < h.markerSize)
                  ) {
                  ...
                  0 < q &&
                    ...
                    (h.connectNullData
                      ? b.setLineDash &&
                        ...
                        (h.options.nullDataLineDashType ||
                          !r[q - 1].lineDashType) &&
                        ((s[s.length - 1].newLineDashArray = B),
                        (D = h.nullDataLineDashType))
                      : (d(y, x), (s = []), (da = []))),
                    (g = !0);
            d(y, x);
            W.drawMarkers(f);
    ...
    l.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = this._eventManager.ghostCtx,
          ...
          n = this.options.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.options.dataPointWidth
            ? this.dataPointWidth
            : 1;
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < v.length)
            for (
              ...
              if (
                (v[n].getTime ? (r = v[n].x.getTime()) : (r = v[n].x),
                "number" !== typeof v[n].y)
              ) {
                if (0 < n && !D && s.connectNullData)
                  var w =
                    s.options.nullDataLineDashType || !v[n - 1].lineDashType
                ...
                k =
                  0 === s.dataPointEOs[n].cumulativeSum
                    ? q
                    : a.axisY.convertValueToPixel(
                        s.dataPointEOs[n].cumulativeSum
                      );
                h =
                  0 === s.dataPointEOs[n].cumulativeSumYStartValue
                    ? q
                    : a.axisY.convertValueToPixel(
                        s.dataPointEOs[n].cumulativeSumYStartValue
                      );
                m = a.axisX.reversed
                  ? (m +
                      (a.plotType.totalDataSeries * p) / 2 -
                      (a.previousDataSeriesCount + g) * p) <<
                    0
                  : (m -
                      (a.plotType.totalDataSeries * p) / 2 +
                      (a.previousDataSeriesCount + g) * p) <<
                ...
                var S,
                  T = m;
                S =
                  ("undefined" !== typeof v[n].isIntermediateSum &&
                    !0 === v[n].isIntermediateSum) ||
                  ("undefined" !== typeof v[n].isCumulativeSum &&
                ...
                0 < n &&
                  y &&
                  (!D || s.connectNullData) &&
                  (D && c.setLineDash && c.setLineDash(N(w, u)),
                  c.beginPath(),
                  c.moveTo(y, B - x),
                  c.lineTo(T, S - x),
                  0 < u && c.stroke(),
                ...
                (v[n].indexLabel ||
                  s.indexLabel ||
                  v[n].indexLabelFormatter ||
                  s.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: "waterfall",
                    dataPoint: v[n],
                    dataSeries: s,
                    point: { x: m + (E - m) / 2, y: 0 <= v[n].y ? k : h },
    ...
    var Y = function (a, d, c, b, e, f, n, m, k) {
      if (!(0 > c)) {
    ...
    l.prototype.renderPie = function (a) {
      function d() {
        if (h && r) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < r.length; e++) {
            ...
            if (h.indexLabelFormatter || f.indexLabelFormatter)
              l = {
                chart: k.options,
                dataSeries: h,
                dataPoint: f,
            ...
            q = f.indexLabelFormatter
              ? f.indexLabelFormatter(l)
              : f.indexLabel
              ? k.replaceKeywordsWithValue(f.indexLabel, f, h, e)
              : h.indexLabelFormatter
              ? h.indexLabelFormatter(l)
              : h.indexLabel
              ? k.replaceKeywordsWithValue(h.indexLabel, f, h, e)
              : f.label
              ? f.label
              : "";
            k._eventManager.objectMap[n] = m;
            m.center = { x: z.x, y: z.y };
            m.y = f.y;
            m.radius = B;
            m.percentInnerRadius = E;
            m.indexLabelText = q;
            m.indexLabelPlacement = h.indexLabelPlacement;
            m.indexLabelLineColor = f.indexLabelLineColor
              ? f.indexLabelLineColor
              : h.options.indexLabelLineColor
              ? h.options.indexLabelLineColor
              : f.color
              ? f.color
              : h._colorSet[e % h._colorSet.length];
            m.indexLabelLineThickness = s(f.indexLabelLineThickness)
              ? h.indexLabelLineThickness
              : f.indexLabelLineThickness;
            m.indexLabelLineDashType = f.indexLabelLineDashType
              ? f.indexLabelLineDashType
              : h.indexLabelLineDashType;
            m.indexLabelFontColor = f.indexLabelFontColor
              ? f.indexLabelFontColor
              : h.indexLabelFontColor;
            m.indexLabelFontStyle = f.indexLabelFontStyle
              ? f.indexLabelFontStyle
              : h.indexLabelFontStyle;
            m.indexLabelFontWeight = f.indexLabelFontWeight
              ? f.indexLabelFontWeight
              : h.indexLabelFontWeight;
            m.indexLabelFontSize = s(f.indexLabelFontSize)
              ? h.indexLabelFontSize
              : f.indexLabelFontSize;
            m.indexLabelFontFamily = f.indexLabelFontFamily
              ? f.indexLabelFontFamily
              : h.indexLabelFontFamily;
            m.indexLabelBackgroundColor = f.indexLabelBackgroundColor
              ? f.indexLabelBackgroundColor
              : h.options.indexLabelBackgroundColor
              ? h.options.indexLabelBackgroundColor
              : h.indexLabelBackgroundColor;
            m.indexLabelMaxWidth = f.indexLabelMaxWidth
          ...
          for (e = 0; e < r.length; e++)
            (m = g[(c + e) % r.length]),
              1 < a &&
                m.midAngle > Math.PI / 2 - u &&
                m.midAngle < Math.PI / 2 + u &&
                (f <= a / 2 && !q
                  ? ((m.hemisphere = "right"), f++)
        ...
        for (b = 0; b < r.length; b++) {
          ...
          if (d > c) {
            ...
            m &&
              ((e = {}),
              (e.dataSeries = h),
              (e.dataPoint = h.dataPoints[b]),
              (e.index = b),
              k.toolTip.highlightObjects([e]));
            Y(
              k.plotArea.ctx,
              g[b].center,
              g[b].radius,
              r[b].color ? r[b].color : h._colorSet[b % h._colorSet.length],
              h.type,
              c,
              d,
              h.fillOpacity,
          ...
          (c = g[b]),
            c.indexLabelText &&
              ...
              "inside" !== c.indexLabelPlacement &&
                ...
                ((d = c.center.x + B * Math.cos(c.midAngle)),
                (e = c.center.y + B * Math.sin(c.midAngle)),
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < r.length) {
          var k = g[a];
          if (
            (0 > c && k.indexLabelTextBlock.y < m) ||
            (0 < c && k.indexLabelTextBlock.y > n)
          )
            return 0;
          var p = 0,
            q = 0,
            q = (p = p = 0);
          0 > c
            ? k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 > m &&
              k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 + c <
                m &&
              (c = -(
                m -
                (k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 + c)
          ...
          m =
            "right" === k.hemisphere
              ? z.x + Math.sqrt(Math.pow(t, 2) - Math.pow(c - z.y, 2))
              : z.x - Math.sqrt(Math.pow(t, 2) - Math.pow(c - z.y, 2));
          ...
          for (n = 1; n < r.length; n++)
            if (
              ((m = (a - n + g.length) % g.length),
              g[m].hemisphere !== g[a].hemisphere)
            ) {
              m = null;
              break;
            } else if (
              ...
              (0 > b(g[m], g[a]) ||
                ("right" === g[a].hemisphere
                  ? g[m].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y
                  : g[m].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y))
            )
              break;
            else m = null;
            ...
            ? ((n = "right" === k.hemisphere ? q : p),
              ...
              null !== n &&
                ...
                (c =
                  k.indexLabelTextBlock.y -
                  k.indexLabelTextBlock.height / 2 -
                  (g[n].indexLabelTextBlock.y +
                    g[n].indexLabelTextBlock.height / 2)),
                c - q < l &&
                  ((m = -q),
                  (n = f(n, m, d + 1)),
                  +n.toFixed(x) > +m.toFixed(x) &&
                    (h = c > l ? -(c - l) : -(q - (n - m))))))
            : 0 < c &&
              ((n = "right" === k.hemisphere ? p : q),
              (h = c),
              null !== n &&
                ((q = c),
                (c =
                  g[n].indexLabelTextBlock.y -
                  g[n].indexLabelTextBlock.height / 2 -
                  (k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2)),
                c - q < l &&
                  ((m = q),
                  (n = f(n, m, d + 1)),
                  +n.toFixed(x) < +m.toFixed(x) &&
                    (h = c > l ? c - l : q - (m - n)))));
          h &&
            ((d = k.indexLabelTextBlock.y + h),
            (c = 0),
            (c =
              "right" === k.hemisphere
                ? z.x + Math.sqrt(Math.pow(t, 2) - Math.pow(d - z.y, 2))
                : z.x - Math.sqrt(Math.pow(t, 2) - Math.pow(d - z.y, 2))),
            k.midAngle > Math.PI / 2 - u && k.midAngle < Math.PI / 2 + u
              ? ((m = (a - 1 + g.length) % g.length),
                (m = g[m]),
                (a = g[(a + 1 + g.length) % g.length]),
                "left" === k.hemisphere &&
                "right" === m.hemisphere &&
                c > m.indexLabelTextBlock.x
                  ? (c = m.indexLabelTextBlock.x - 15)
                  : "right" === k.hemisphere &&
                    "left" === a.hemisphere &&
                    c < a.indexLabelTextBlock.x &&
                    (c = a.indexLabelTextBlock.x + 15))
              : k.midAngle > (3 * Math.PI) / 2 - u &&
                k.midAngle < (3 * Math.PI) / 2 + u &&
                ((m = (a - 1 + g.length) % g.length),
                (m = g[m]),
                (a = g[(a + 1 + g.length) % g.length]),
                ...
                c < m.indexLabelTextBlock.x
                  ...
                  : "left" === k.hemisphere &&
                    ...
                    c > a.indexLabelTextBlock.x &&
                    (c = a.indexLabelTextBlock.x - 15)),
            (k.indexLabelTextBlock.y = d),
            (k.indexLabelTextBlock.x = c),
            (k.indexLabelAngle = Math.atan2(
              k.indexLabelTextBlock.y - z.y,
              k.indexLabelTextBlock.x - z.x
            )));
        }
        return h;
      }
      function n() {
        ...
        for (
          ...
          if ("inside" !== h.indexLabelPlacement) {
              ...
              if (null !== y) {
                ...
                if (0 > D) {
                  for (var F = (s = 0), J = 0; J < r.length; J++)
                    J !== a &&
                      g[J].hemisphere === n.hemisphere &&
                      (g[J].indexLabelTextBlock.y < n.indexLabelTextBlock.y
                        ? s++
                        : F++);
                  s = (D / (s + F || 1)) * F;
                  var F = -1 * (D - s),
                  ...
                  "right" === n.hemisphere
                    ? ((J = f(a, s)),
                      (F = -1 * (D - J)),
                      (I = f(y, F)),
                      +I.toFixed(x) < +F.toFixed(x) &&
                        +J.toFixed(x) <= +s.toFixed(x) &&
                        f(a, -(F - I)))
                    : ((J = f(y, s)),
                      (F = -1 * (D - J)),
                      (I = f(a, F)),
            ...
            for (a = 0; a < r.length; a++)
              (n = g[a]),
                (t = "pie" === h.type ? 0.7 * B : 0.8 * B),
                (y = z.x + t * Math.cos(n.midAngle)),
                (s = z.y + t * Math.sin(n.midAngle)),
                (n.indexLabelTextBlock.x = y),
                (n.indexLabelTextBlock.y = s);
          for (a = 0; a < r.length; a++)
            if (
              ((n = g[a]),
              (y = n.indexLabelTextBlock.measureText()),
              ...
              (y = y = 0),
                ...
                0 < y &&
                  (!m &&
                    ...
                    ((s =
                      "right" === n.hemisphere
                        ? p.x2 - n.indexLabelTextBlock.x
                        : n.indexLabelTextBlock.x - p.x1),
                    0.3 * n.indexLabelTextBlock.maxWidth > s
                      ? (n.indexLabelText = "")
                      : (n.indexLabelTextBlock.maxWidth = 0.85 * s),
                    0.3 * n.indexLabelTextBlock.maxWidth < s &&
                      (n.indexLabelTextBlock.x -=
                  ...
                  ((y /= Math.abs(Math.cos(n.indexLabelAngle))),
                  9 < y && (y *= 0.3),
                  y > d && (d = y)),
                (y = y = 0),
                  ...
                  (!m &&
                    ...
                    ((s =
                      0 < n.indexLabelAngle && n.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === f(a, y * s) && f(a, 2 * s)),
                  Math.abs(n.indexLabelTextBlock.x - z.x) < B &&
                    ((y /= Math.abs(Math.sin(n.indexLabelAngle))),
                    9 < y && (y *= 0.3),
                    y > d && (d = y)));
              ...
              if (((f = !1), (u = g[h]), u.indexLabelText)) {
                ...
                if (null !== n) {
                  ...
                  k
                    ? (0 > a && (a = h),
                      n !== a && ((c = n), (d += -D)),
                      0 === h % Math.max(r.length / 10, 3) && (f = !0))
                    : (f = !0);
                  f &&
                    0 < d &&
                    0 <= a &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var h = this.data[a.dataSeriesIndexes[0]],
          ...
          u = (20 / 180) * Math.PI,
          x = 6,
          z = { x: (p.x2 + p.x1) / 2, y: (p.y2 + p.y1) / 2 },
          D = 0;
        a = !1;
        for (var y = 0; y < r.length; y++)
          (D += Math.abs(r[y].y)),
            !a &&
              "undefined" !== typeof r[y].indexLabel &&
              null !== r[y].indexLabel &&
              0 < r[y].indexLabel.toString().length &&
              (a = !0),
            !a &&
              "undefined" !== typeof r[y].label &&
              null !== r[y].label &&
              0 < r[y].label.toString().length &&
              (a = !0);
        if (0 !== D) {
          a =
            a ||
          ...
          var B =
            "inside" !== h.indexLabelPlacement && a
              ? (0.75 * Math.min(p.width, p.height)) / 2
              : (0.92 * Math.min(p.width, p.height)) / 2;
    ...
    l.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        if (0 === g) return -1;
        for (
          var n = (d[0] = 0), m = 0, k, r, b = b - a, n = !1, h = 0;
          h < x.length;
          h++
        )
        ...
        if (u && x) {
          ...
          for (var y = 0, B = x.length - 1; y < x.length || 0 <= B; y++, B--) {
            ...
            a = b.color
              ? b.color
              : u.reversed
              ? u._colorSet[(x.length - 1 - y) % u._colorSet.length]
      ...
      function e() {
        ...
        for (
          var g,
            h = M - $ - V / 2,
            h = u.options.indexLabelMaxWidth
              ? u.indexLabelMaxWidth > h
                ? h
                : u.indexLabelMaxWidth
              : h,
            m = H.length - 1;
        ...
        if (e)
          for (m = H.length - 1; 0 <= m; m--)
            (a = O[m]),
              ...
              u.reversed
                ? (H[m].textBlock.y + H[m].height > na + D &&
                    (H[m].textBlock.y = na + D - H[m].height),
                  H[m].textBlock.y < sa - D && (H[m].textBlock.y = sa - D))
                : (H[m].textBlock.y < na - D && (H[m].textBlock.y = na - D),
                  H[m].textBlock.y + H[m].height > sa + D &&
                    (H[m].textBlock.y = sa + D - H[m].height));
      }
      function f() {
        var a, b, c, d;
          ...
          for (var e = 0; e < O.length; e++)
            0 == H[e].textBlock.text.length
              ...
              : ((a = O[e]),
                ...
                u.reversed
                  ? (H[e].textBlock.y + H[e].height > na + D &&
                      (H[e].textBlock.y = na + D - H[e].height),
                    H[e].textBlock.y < sa - D && (H[e].textBlock.y = sa - D))
                  : (H[e].textBlock.y < na - D && (H[e].textBlock.y = na - D),
                    H[e].textBlock.y + H[e].height > sa + D &&
                      (H[e].textBlock.y = sa + D - H[e].height)));
        else
      ...
      function n() {
          ...
          for (var m, n = 1; n < h; n++) {
            ...
            for (var r = H.length - 1; 0 <= r; r--)
              !H[r].isDirty &&
                ...
                ((m = p(r)),
                !(m >= H.length - 1) &&
                  H[r].textBlock.y + H[r].height + ca > H[m].textBlock.y &&
                  (H[r].textBlock.y =
          ...
          for (m = O.length - 1; 0 < m; m--)
            if (!H[m].isDirty) {
              ...
              if (H[m].textBlock.y < H[e].textBlock.y + H[e].height) {
                ...
                for (
                  h = 0;
                  H[f].textBlock.y < H[e].textBlock.y + H[e].height + ca;
        ...
        for (var d, e, f, g, h, n, k = 1, r = 0; r < 2 * k; r++) {
          for (
            ...
            (f = H[l]),
            (g = f.textBlock),
            (n = (h = p(l) < O.length ? H[p(l)] : null) ? h.textBlock : null),
            (d = +f.height.toFixed(6)),
            (e = +g.y.toFixed(6)),
            !f.isDirty &&
              h &&
              e + d + ca > +n.y.toFixed(6) &&
              ((d = g.y + d + ca - n.y),
              (e = a(l, -d)),
              e < d && (0 < e && (d -= e), (e = a(p(l), d)), e != d)));
            l--
          );
          b();
        }
      ...
      function m(a, b) {
        return (
          (b < O.length ? H[b].textBlock.y : u.reversed ? na + D : sa + D) -
          (0 > a
            ? u.reversed
              ? sa - D
              : na - D
            : H[a].textBlock.y + H[a].height + ca)
        );
      }
      function k(a, b, c) {
        var d,
        ...
        if (0 === Y.length) m = ha;
          ...
          e =
            (D *
              (1 != Y.length || (0 != Y[0] && Y[0] != O.length - 1) ? 2 : 1)) /
            h();
          for (var p = 0; p < O.length; p++) {
            ...
            m.push(ha[p] + d);
            if (0 <= Y.indexOf(p) || (p < O.length && 0 <= Y.indexOf(p + 1)))
              d += e;
          }
        }
        g = (function () {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          ...
          if (
            (!I &&
              "undefined" !== typeof x[S].indexLabel &&
              null !== x[S].indexLabel &&
              0 < x[S].indexLabel.toString().length &&
              (I = !0),
            !I &&
              "undefined" !== typeof x[S].label &&
              null !== x[S].label &&
              0 < x[S].label.toString().length &&
              (I = !0),
            (!I && "function" === typeof u.indexLabelFormatter) ||
              "function" === typeof x[S].indexLabelFormatter)
          )
            I = !0;
        I =
          I ||
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== x.length) {
          ...
          var V = (30 * (M - a)) / 100;
          "funnel" === u.type
            ? ((P = s(u.options.neckHeight) ? 0.35 * E : u.neckHeight),
              (G = s(u.options.neckWidth) ? 0.25 * a : u.neckWidth),
              "string" === typeof P && P.match(/%$/)
                ? ((P = parseInt(P)), (P = (P * E) / 100))
                : (P = parseInt(P)),
              ...
              G > a ? (G = a - 0.5) : 0 >= G && (G = 0))
            : "pyramid" === u.type &&
              ((G = P = 0), (u.reversed = u.reversed ? !1 : !0));
          var y = S + a / 2,
            X = S,
            $ = S + a,
            na = u.reversed ? R : Z,
          ...
          if (-1 !== S) {
            if (u.reversed)
              for (F.push(U), G = S.length - 1; 0 < G; G--)
                (U += S[G]), F.push(U);
            else for (G = 0; G < S.length; G++) (U += S[G]), F.push(U);
            if (u.reversed)
              for (G = 0; G < S.length; G++)
                F[G] < xa
                  ? (a.push(K), y.push(W), (ba = G))
                  : (a.push((F[G] - na + aa * X) / aa),
                    y.push((F[G] - na + ea * $) / ea));
            else
              for (G = 0; G < S.length; G++)
                F[G] < xa
            ...
            for (G = 0; G < S.length - 1; G++)
              (U = u.reversed
                ? x[x.length - 1 - G].color
                  ? x[x.length - 1 - G].color
                  : u._colorSet[(x.length - 1 - G) % u._colorSet.length]
                : x[G].color
                ? x[G].color
            ...
            for (G = 0; G < x.length; G++)
              x[G].exploded &&
                ((S = !0), u.reversed ? Y.push(x.length - 1 - G) : Y.push(G));
            ...
            I &&
              u.visible &&
              ("inside" === u.indexLabelPlacement || w.animationEnabled || r(Q),
              w.animationEnabled || l());
            if (!I)
              for (G = 0; G < x.length; G++)
                (B = u.dataPointIds[G]),
                  (a = {
            ...
            !w.animationEnabled && S
              ? k(w, -1, 0)
              : w.animationEnabled && !w.animatedRender && k(w, -1, 0);
    ...
    l.prototype.exportChart = function (a) {
      ...
      if (b && d && c) {
        ...
        if ("undefined" !== typeof Blob && new Blob()) {
          for (
            var n = b.replace(/^data:[a-z\/]*;base64,/, ""),
              n = atob(n),
            ...
            m[k] = n.charCodeAt(k);
          d = new Blob([m.buffer], { type: "image/" + d });
          try {
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        if ("color" === a)
          return "waterfall" === c.type
            ...
            ? c.color
              ? c.color
              : c._colorSet[h % c._colorSet.length]
            : d.color
            ? d.color
            : c.color
            ? c.color
        ...
        if ("x" === a)
          if (
            "dateTime" === c.axisX.valueType ||
            "dateTime" === c.xValueType ||
            (d.x && d.x.getTime)
          ) {
            if (
              f.plotInfo.plotTypes[0].plotUnits[0].axisX &&
              !f.plotInfo.plotTypes[0].plotUnits[0].axisX.logarithmic
            )
              return Aa(
                g,
    ...
    F.prototype.setLayout = function () {
      ...
      for (var r = 0; r < this.dataSeries.length; r++) {
        ...
        if (q.dataPoints && q.dataPoints.length)
          if (
            ...
            var p = (q.legendMarkerType = q.legendMarkerType
                ? q.legendMarkerType
                : ("line" !== q.type &&
                    "stepLine" !== q.type &&
                    "spline" !== q.type &&
                ...
                ? "error" === q.type && q._linkedSeries
                  ? q._linkedSeries.legendMarkerType
                    ? q._linkedSeries.legendMarkerType
                    : I.getDefaultLegendMarker(q._linkedSeries.type)
                  : I.getDefaultLegendMarker(q.type)
                : q.markerType),
              g = q.legendText
                ? q.legendText
                ...
                : q.name,
              l = (q.legendMarkerColor = q.legendMarkerColor
                ? q.legendMarkerColor
                : q.markerColor
                ? q.markerColor
                : "error" === q.type
              ...
              t =
                ...
                ("line" !== q.type &&
                  ...
                  : 0,
              v = q.legendMarkerBorderColor
                ? q.legendMarkerBorderColor
                : q.markerBorderColor,
              u = q.legendMarkerBorderThickness
            ...
            for (var x = 0; x < q.dataPoints.length; x++) {
              var z = q.dataPoints[x],
                p = z.legendMarkerType
                  ? z.legendMarkerType
                  : q.legendMarkerType
                  ? q.legendMarkerType
                  : I.getDefaultLegendMarker(q.type),
                ...
                l = z.legendMarkerColor
                  ...
                  : q.color
                  ? q.color
                  : q._colorSet[x % q._colorSet.length],
                t = 0.75 * this.lineHeight,
                v = z.legendMarkerBorderColor
                ...
                u = z.legendMarkerBorderThickness
                  ...
                  : q.legendMarkerBorderThickness
                  ? q.legendMarkerBorderThickness
                  : z.markerBorderThickness || q.markerBorderThickness
                  ? Math.max(1, Math.round(0.2 * t))
                  : 0,
              ...
              (z.showInLegend || (q.showInLegend && !1 !== z.showInLegend)) &&
                k.push(p);
            }
      }
      ...
      if (0 < k.length) {
            ...
            if ("horizontal" === this.orientation) {
              ...
              (p.textBlock = new ja(this.ctx, {
                ...
                this.height < n - this.lineHeight
                  ...
                  : ((q = h[x]), (x = (x + 1) % h.length)),
                (this.height += p.textBlock.height);
        ...
        this.itemWidth = l;
        this.height =
          !1 === this.itemWrap ? h.length * this.lineHeight : this.height + g;
      ...
      for (r = 0; r < this.items.length; r++)
        (p = k[r]),
          ...
          (this.chart._eventManager.objectMap[p.id] = {
            id: p.id,
    ...
    F.prototype.render = function () {
      ...
      for (var m = 0, k = 0; k < n.length; k++) {
        for (var h = n[k], r = 0, q = 0; q < h.items.length; q++) {
          var p = h.items[q],
            g =
              p.textBlock.x + a + (0 === q ? 0.2 * f : this.horizontalSpacing),
            l = d + m,
            s = g;
          this.chart.data[p.dataSeriesIndex].visible ||
          ...
          this.ghostCtx.fillRect(
            s,
            p.textBlock.y - this.lineHeight / 2,
            p.textBlock.x + p.textBlock.width - s,
            p.textBlock.height
          );
          p.x1 = this.chart._eventManager.objectMap[p.id].x1 = s;
          p.y1 = this.chart._eventManager.objectMap[p.id].y1 =
            p.textBlock.y - this.lineHeight / 2;
          p.x2 = this.chart._eventManager.objectMap[p.id].x2 =
            p.textBlock.x + p.textBlock.width;
          p.y2 = this.chart._eventManager.objectMap[p.id].y2 =
            p.textBlock.y + p.textBlock.height - this.lineHeight / 2;
        }
        m += r;
      }
    };
        ...
        if (0 <= f && f < this.dataPoints.length) {
          var b = this.dataPoints[f],
            q = this.axisX.logarithmic
              ...
              : Math.abs(b.x - a);
          q < c.distance &&
            ((c.dataPoint = b), (c.distance = q), (c.index = f));
          b = q;
          b <= m ? (m = b) : 0 < n ? k++ : h++;
          ...
          if (p) {
            switch (this.type) {
              ...
              case "rangeSplineArea":
                ...
                t = c ? 20 : s;
                l = Math.min(
                  Math.sqrt(Math.pow(p.x1 - a, 2) + Math.pow(p.y1 - d, 2)),
                  Math.sqrt(Math.pow(p.x1 - a, 2) + Math.pow(p.y2 - d, 2))
                );
                l <= t &&
                  b.push({
                    dataPoint: g,
              ...
              case "doughnut":
                ...
                l < p.radius &&
                  ...
                  (s = Number(
                    (
                      (((180 * (p.startAngle / Math.PI)) % 360) + 360) %
                      360
                    ).toFixed(12)
                  )),
                  (t = Number(
                    (
                      (((180 * (p.endAngle / Math.PI)) % 360) + 360) %
                      360
                    ).toFixed(12)
                  )),
                  0 === t && 1 < p.endAngle && (t = 360),
                  s >= t && 0 !== g.y && ((t += 360), l < s && (l += 360)),
                  l > s &&
                    l < t &&
                    (b.push({
                      dataPoint: g,
              ...
              case "pyramid":
                ...
                d > l.y1 &&
                  ...
                  (l.y6
                    ? d > l.y6
                      ? ((f =
                          l.x6 + ((l.x5 - l.x6) / (l.y5 - l.y6)) * (d - l.y6)),
                        (l =
                          l.x3 + ((l.x4 - l.x3) / (l.y4 - l.y3)) * (d - l.y3)))
                      : ((f =
                          l.x1 + ((l.x6 - l.x1) / (l.y6 - l.y1)) * (d - l.y1)),
                        (l =
                          l.x2 + ((l.x3 - l.x2) / (l.y3 - l.y2)) * (d - l.y2)))
                    : ((f =
                        l.x1 + ((l.x4 - l.x1) / (l.y4 - l.y1)) * (d - l.y1)),
                      (l =
                        l.x2 + ((l.x3 - l.x2) / (l.y3 - l.y2)) * (d - l.y2))),
                  a > f &&
                    a < l &&
              ...
              case "boxAndWhisker":
                if (
                  (a >= p.x1 - p.borderThickness / 2 &&
                    a <= p.x2 + p.borderThickness / 2 &&
                    d >= p.y4 - p.borderThickness / 2 &&
                    d <= p.y1 + p.borderThickness / 2) ||
                  (Math.abs(p.x2 - a + p.x1 - a) < p.borderThickness &&
                    d >= p.y1 &&
                    d <= p.y4)
                )
                  b.push({
              ...
              case "candlestick":
                if (
                  (a >= p.x1 - p.borderThickness / 2 &&
                    a <= p.x2 + p.borderThickness / 2 &&
                    d >= p.y2 - p.borderThickness / 2 &&
                    d <= p.y3 + p.borderThickness / 2) ||
                  (Math.abs(p.x2 - a + p.x1 - a) < p.borderThickness &&
                    d >= p.y1 &&
                    d <= p.y4)
                )
            ...
            if (((c = this.logLabelValues[b]), c < this.viewportMinimum)) b++;
              ...
              a ||
                ((a = this.labelFormatter
                  ...
                  ? this.labels[l]
                  : ea(l, this.valueFormatString, this.chart._cultureInfo)),
                (a = new ja(this.ctx, {
                  x: 0,
                  y: 0,
                  maxWidth: f,
        ...
        for (
          ...
          a ||
            ((a = this.labelFormatter
              ...
              : "axisX" === this.type && this.labels[l]
              ? this.labels[l]
              : Aa(l, this.valueFormatString, this.chart._cultureInfo)),
            (a = new ja(this.ctx, {
              x: 0,
              y: 0,
              maxWidth: f,
                  ...
                  (l =
                    0 != this.labelAngle
                      ? (h -
                        ...
                        Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))
                      : f),
                  (this.sessionVariables.labelMaxHeight = n = this.labelWrap
                    ? (h -
                        l *
                          Math.sin(
                            (Math.PI / 180) * Math.abs(this.labelAngle)
            ...
            for (c = 0; c < this._labels.length; c++)
              (a = this._labels[c].textBlock),
                ...
                (a.fontSize = this.labelFontSize = s(this.options.labelFontSize)
                  ...
                  : this.options.labelFontSize),
                (a.angle = this.labelAngle = s(this.options.labelAngle)
                  ? s(this.sessionVariables.labelAngle)
                    ? (this.sessionVariables.labelAngle = this.labelAngle)
                    : this.sessionVariables.labelAngle
                  : this.labelAngle),
                (a.wrap = this.labelWrap = s(this.options.labelWrap)
          ...
          (n =
            ...
            s(f.labelBackgroundColor) &&
              (s(f.startValue) && 0 !== f.startValue
                ? (f.labelBackgroundColor = t ? "transparent" : null)
    ...
    E.setLayout = function (a, d, c, b, e, f) {
      ...
      for (g = 0; g < p.length; g++)
        if (p[g] && p[g].scaleBreaks && p[g].scaleBreaks._appliedBreaks.length)
          for (
            var t = p[g].scaleBreaks._appliedBreaks, v = 0;
            v < t.length && !(t[v].startValue > p[g].viewportMaximum);
            v++
          )
            t[v].endValue < p[g].viewportMinimum ||
              (s(p[g].scaleBreaks.firstBreakIndex) &&
                (p[g].scaleBreaks.firstBreakIndex = v),
              t[v].startValue >= p[g].viewPortMinimum &&
                (p[g].scaleBreaks.lastBreakIndex = v));
      for (
        var w = (v = 0),
          u = 0,
          x = 0,
        ...
        p[g] &&
          p[g].title &&
          (p[g]._titleTextBlock = new ja(p[g].ctx, {
            text: p[g].title,
            horizontalAlign: "center",
        ...
        if (p[g].title)
          switch (p[g]._position) {
            case "left":
              ...
              p[g]._titleTextBlock.maxHeight = p[g].titleWrap
                ? 0.8 * f.width
                : 1.5 * p[g].titleFontSize;
            ...
            case "right":
              ...
              break;
            default:
              (p[g]._titleTextBlock.maxWidth = p[g].titleMaxWidth || f.width),
                (p[g]._titleTextBlock.maxHeight = p[g].titleWrap
                  ? 0.8 * f.height
                  : 1.5 * p[g].titleFontSize),
                (p[g]._titleTextBlock.angle = 0);
          }
      if ("normal" === e) {
        for (
          var x = [], z = [], D = [], y = [], M = [], N = [], P = [], Q = [];
          ...
          var G = 0,
            ...
            aa = 0;
          if (c && 0 < c.length)
            for (D = [], g = O = 0; g < c.length; g++)
              D.push(
                Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)
              ),
                (O += D[g]),
                (K += c[g] && !l.isNavigator ? c[g].margin : 0);
          else
            D.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
          P.push(D);
          if (b && 0 < b.length)
            for (y = [], g = aa = 0; g < b.length; g++)
              y.push(
          ...
          k = Math.round(
            f.x2 - aa - $ > l.width - q ? l.width - q : f.x2 - aa - $
          );
          if (a && 0 < a.length)
            for (x = [], g = U = 0; g < a.length; g++)
              a[g] && (a[g].lineCoordinates = {}),
                (a[g].lineCoordinates.width = Math.abs(k - n)),
                a[g].title &&
                ...
                (U += x[g]),
                (e += a[g] && !l.isNavigator ? a[g].margin : 0);
          else
            x.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
          M.push(x);
          if (d && 0 < d.length)
            for (z = [], g = W = 0; g < d.length; g++)
              d[g] && (d[g].lineCoordinates = {}),
                (d[g].lineCoordinates.width = Math.abs(k - n)),
                d[g].title &&
                ...
                (W += z[g]),
                (X += d[g] && !l.isNavigator ? d[g].margin : 0);
          else
              ...
              a[g] &&
                ...
                a[g]._labels &&
                  ...
                  (w =
                    ...
                    (h.textBlock.height - m.textBlock.fontSize / 2) *
                ...
                !a[g] ||
                  ...
                  0 < a[g].labelAngle
                    ? E + u > k &&
                      (m += 0 < a[g].labelAngle ? E + u - k - aa : 0)
                    : 0 > a[g].labelAngle
                    ? B - w < n &&
                      B - w < a[g].viewportMinimum &&
                      (F =
                        n -
                        (K +
                          a[g].tickLength +
                  ...
                  0 < m
                    ...
                    : a[g].viewportMaximum === a[g].maximum &&
                      ...
                      (0 < F && (n += F), 0 < m && (k -= m))),
                l.panEnabled
                  ? (U = s(l.sessionVariables.axisX.height)
                      ? (l.sessionVariables.axisX.height = U)
                      : l.sessionVariables.axisX.height)
                  : (l.sessionVariables.axisX.height = U),
                (m = Math.round(f.y2 - U - e + G)),
                (h = Math.round(f.y2)),
                (a[g].lineCoordinates.x2 = k),
                (a[g].lineCoordinates.width = k - n),
                (a[g].lineCoordinates.y1 = m),
                (a[g].lineCoordinates.y2 = m + a[g].lineThickness / 2),
                ...
                d[g]._labels &&
                  ...
                  (u =
                    ...
                    (m.textBlock.height - m.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(m.textBlock.angle)))),
                l.panEnabled
                  ? (W = s(l.sessionVariables.axisX2.height)
                      ? (l.sessionVariables.axisX2.height = W)
                      : l.sessionVariables.axisX2.height)
                  : (l.sessionVariables.axisX2.height = W),
                (m = Math.round(f.y1)),
                (h = Math.round(f.y2 + d[g].margin)),
                (d[g].lineCoordinates.y1 = m + W + X - R),
                (d[g].lineCoordinates.y2 = m),
              ...
              b[g] &&
                ...
                (K =
                  b[g]._labels && 0 < b[g]._labels.length
                    ...
                    : 0),
                (m = Math.round(
                  f.y1 + W + X < Math.max(K, q) ? Math.max(K, q) : f.y1 + W + X
                )),
                (K =
                  0 < a.length
                    ? 0
            ...
            for (g = 0; g < a.length; g++)
              a[g] &&
                ...
                a[g]._labels &&
                  ...
                  (n = a[g].getApparentDifference(a[g].viewportMinimum, n)),
                  (E = a[g].logarithmic
                    ? (1 < n
                        ? (Math.log(n) /
                            a[g].conversionParameters.lnLogarithmBase) *
                    ...
                    : (0 < n
                        ? n * Math.abs(a[g].conversionParameters.pixelPerUnit)
                        : 0) + a[g].lineCoordinates.x1)));
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++)
              d[g].calculateValueToPixelConversionParameters(),
                ...
                d[g]._labels &&
                  ...
                  (n = d[g].getApparentDifference(d[g].viewportMinimum, n)),
                  (E = d[g].logarithmic
                    ? (1 < n
                        ? (Math.log(n) /
                            d[g].conversionParameters.lnLogarithmBase) *
                    ...
                    : (0 < n
                        ? n * Math.abs(d[g].conversionParameters.pixelPerUnit)
                        : 0) + d[g].lineCoordinates.x1));
          for (g = 0; g < p.length; g++)
            "axisY" === p[g].type &&
              (p[g].calculateValueToPixelConversionParameters(),
              p[g].calculateBreaksSizeInValues());
          if (0 < v) {
            if (a && 0 < a.length)
              for (g = 0; g < a.length; g++)
                t = M[v - 1][g] === M[v][g] ? !0 : !1;
        ...
        for (N = []; 4 > v; ) {
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                (n = Math.round(f.x1 + Y + e)),
                (k = Math.round(
                  f.x2 - U - X > l.width - 10 ? l.width - 10 : f.x2 - U - X
                )),
                c[g].labelAutoFit &&
                  !s(x) &&
                  (0 < !a.length &&
                  ...
                  0 < !d.length &&
                    (k =
                      0 < c[g].labelAngle
                        ...
                        ? k - z / 2
                        : k)),
                (c[g].lineCoordinates.x1 = n),
                (c[g].lineCoordinates.x2 = k),
                (c[g].lineCoordinates.width = Math.abs(k - n)),
                c[g].title &&
                  (c[g]._titleTextBlock.maxWidth =
                    0 < c[g].titleMaxWidth &&
                  ...
                  (0 < !a.length &&
                    (n =
                      0 < b[g].labelAngle
                        ...
                        : n),
                  0 < !d.length && (k -= y / 2)),
                (b[g].lineCoordinates.x1 = n),
                (b[g].lineCoordinates.x2 = k),
                (b[g].lineCoordinates.width = Math.abs(k - n)),
                b[g].title &&
                  (b[g]._titleTextBlock.maxWidth =
                    0 < b[g].titleMaxWidth &&
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              0 < c[g]._labels.length &&
                ((h = c[g]._labels[0]),
                (m = c[g]._labels[c[g]._labels.length - 1]),
                (x =
                  h.textBlock.width *
                    Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) +
                  (h.textBlock.height - m.textBlock.fontSize / 2) *
          ...
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++)
              b[g] &&
                ...
                ((h = b[g]._labels[0]),
                (m = b[g]._labels[b[g]._labels.length - 1]),
                (D =
                  h.textBlock.width *
                    Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) +
                  (h.textBlock.height - m.textBlock.fontSize / 2) *
          ...
          if (l.panEnabled)
            for (g = 0; g < c.length; g++)
              q[g] = s(l.sessionVariables.axisY.height)
                ? (l.sessionVariables.axisY.height = q[g])
                : l.sessionVariables.axisY.height;
          else
            for (g = 0; g < c.length; g++)
              l.sessionVariables.axisY.height = q[g];
          if (c && 0 < c.length)
            for (g = c.length - 1; 0 <= g; g--)
              (m = Math.round(f.y2)),
                ...
                (c[g].lineCoordinates.y1 = m - (q[g] + c[g].margin + W)),
                (c[g].lineCoordinates.y2 = m - (q[g] + c[g].margin + W)),
                "inside" === c[g].labelPlacement &&
                  0 < g &&
          ...
          if (b && 0 < b.length)
            for (g = b.length - 1; 0 <= g; g--)
              b[g] &&
                ((m = Math.round(f.y1)),
                (h = Math.round(f.y1 + (B[g] + b[g].margin + G))),
                (b[g].lineCoordinates.y1 = h),
                (b[g].lineCoordinates.y2 = h),
                "inside" === b[g].labelPlacement &&
                  0 < g &&
            ...
            for (g = 0; g < a.length; g++) {
                ...
                c && 0 < c.length
                  ? Math.round(
                      c[0]
                        ...
                        : f.y2 - V > l.height - Math.max(K, 10)
                        ? l.height - Math.max(K, 10)
                        : f.y2 - V
                    )
                  : f.y2 > l.height - Math.max(K, 10)
                  ? l.height - Math.max(K, 10)
                  : f.y2;
              if (c && 0 < c.length)
              ...
              if (b && 0 < b.length)
                for (K = 0; K < b.length; K++)
                  b[K] &&
                    b[K].labelAutoFit &&
                    ((k = b[K].lineCoordinates.x1), (n = k - Y));
              a[g].lineCoordinates = {
                x1: k - P,
                y1: m,
                x2: k - P,
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (K = 0; K < b.length; K++)
                  b[K] &&
                    b[K].labelAutoFit &&
                    ((k = b[K].lineCoordinates.x2), (n = k - U));
              d[g].lineCoordinates = {
                x1: k + Q,
                y1: m,
                x2: k + Q,
    ...
    E.render = function (a, d, c, b, e) {
      ...
      if (a && 0 < a.length)
        for (m = 0; m < a.length; m++)
          a[m].renderGrid(),
            t && (a[m].createMask(), a[m].renderBreaksBackground());
      if (d && 0 < d.length)
        for (m = 0; m < d.length; m++)
          d[m].renderGrid(),
            t && (d[m].createMask(), d[m].renderBreaksBackground());
      if (c && 0 < c.length)
        for (m = 0; m < c.length; m++)
          c[m].renderGrid(),
            t && (c[m].createMask(), c[m].renderBreaksBackground());
      if (b && 0 < b.length)
        for (m = 0; m < b.length; m++)
          b[m].renderGrid(),
            t && (b[m].createMask(), b[m].renderBreaksBackground());
      if (a && 0 < a.length)
      ...
      if ("bottom" === this._position) {
        for (h = 0; h < this._labels.length; h++)
          (q = this._labels[h]),
            q.position < this.viewportMinimum ||
              q.position > this.viewportMaximum ||
              ((p = this.getPixelCoordinatesOnAxis(q.position)),
              this.tickThickness &&
                "inside" != this.tickPlacement &&
                ((this.ctx.lineWidth = this.tickThickness),
                (this.ctx.strokeStyle = this.tickColor),
                (b =
                  1 === this.ctx.lineWidth % 2 ? (p.x << 0) + 0.5 : p.x << 0),
                this.ctx.beginPath(),
              ...
              for (h = 0; h < a._labels.length; h++)
                if (
                  ...
                  !(
                    ...
                    ((p = a.getPixelCoordinatesOnAxis(q.position)),
                    a.tickThickness))
                ) {
                  a.ctx.lineWidth = a.tickThickness;
                  a.ctx.strokeStyle = a.tickColor;
                  var b =
                    1 === a.ctx.lineWidth % 2 ? (p.x << 0) + 0.5 : p.x << 0;
                  a.ctx.save();
                  a.ctx.beginPath();
                        ...
                        ? 0 < this.labelAngle
                          ...
                          : p.x -
                            q.textBlock.width *
                              Math.cos((Math.PI / 180) * this.labelAngle)
                        : p.x +
                          (q.textBlock.height - this.labelFontSize) *
                            Math.sin((Math.PI / 180) * this.labelAngle) -
                          (0 < this.labelAngle
                            ? q.textBlock.width *
                              Math.cos((Math.PI / 180) * this.labelAngle)
          ...
          (q = this._labels[h]),
            q.position < this.viewportMinimum ||
              ...
              this.tickThickness &&
                ...
                (this.ctx.strokeStyle = this.tickColor),
                (b =
                  1 === this.ctx.lineWidth % 2 ? (p.y << 0) + 0.5 : p.y << 0),
                this.ctx.beginPath(),
            ...
            function () {
              for (h = 0; h < a._labels.length; h++)
                if (
                  ...
                  a.ctx.strokeStyle = a.tickColor;
                  var b =
                    1 === a.ctx.lineWidth % 2 ? (p.y << 0) + 0.5 : p.y << 0;
                  a.ctx.save();
                  a.ctx.beginPath();
              ...
              if (
                ...
                0 === this.labelAngle
                  ? ((a.x -= c.textBlock.width / 2),
                    (a.y += this.tickLength + c.textBlock.fontSize / 2))
                  : ((a.x -=
                      0 > this.labelAngle
                        ? c.textBlock.width *
                          Math.cos((Math.PI / 180) * this.labelAngle)
                ...
                "top" === this._position
                  ? ((r =
                    ...
                    0 === this.labelAngle
                      ? ((a.x -= c.textBlock.width / 2),
                        (a.y -= this.tickLength + c.textBlock.height))
                      : ((a.x +=
                          (c.textBlock.height -
                            this.tickLength -
                            this.labelFontSize / 2) *
        ...
        if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
          if (s(this.scaleBreaks.lastBreakIndex))
            ...
            for (
              ...
              d.moveTo(k, e),
                d.lineTo(k, this.scaleBreaks._appliedBreaks[m].startPixel + b),
    ...
    E.prototype.calculateAxisParameters = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();
        ...
        if ("axisX" === this.type && c) {
          this.intervalType ||
            (b / 1 <= a
              ...
              : ((this.interval =
                  b / (1 * R.yearDuration) <= a
                    ? 1
                    : b / (2 * R.yearDuration) <= a
                    ? 2
                    : b / (4 * R.yearDuration) <= a
                    ? 4
                    : Math.floor(
                        E.getNiceNumber(b / (a - 1), !0) / R.yearDuration
                      )),
        ...
        this.valueFormatString ||
          (this.valueFormatString = E.generateValueFormatString(this.range, 2));
      }
    };
    E.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      if (this.scaleBreaks)
        for (k = 0; k < this.scaleBreaks._appliedBreaks.length; k++)
          if (
            ((!s(this.sessionVariables.newViewportMinimum) &&
              this.sessionVariables.newViewportMinimum >=
                this.scaleBreaks._appliedBreaks[k].startValue) ||
              (!s(this.options.minimum) &&
                this.options.minimum >=
                  this.scaleBreaks._appliedBreaks[k].startValue) ||
              (!s(this.options.viewportMinimum) &&
      ...
      k = Math.pow(
        this.logarithmBase,
        E.getNiceNumber(Math.abs(Math.log(k) / d), !1)
      );
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = E.getNiceExponent(Math.log(k) / d / (a - 1), !0)),
          (c = E.getNiceNumber(m / (a - 1), !0)));
      if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
        this.viewportMinimum =
          "axisX" === this.type
            ? b / Math.sqrt(f)
          ...
          : "axisY" === this.type &&
            ...
            isFinite(b) || isFinite(e)
              ? 1 === b && 1 === e
                ...
                : 1 === e / b
                ? ((k = Math.pow(this.logarithmBase, this.interval)),
                  (e *= k),
                  (b /= k))
                : b > e
                ? ((k = Math.min(0.01 * (b / e), 5)),
                  1 <= e ? (b = e / k) : (e = b * k))
                : ((k = Math.min(
                    (e / b) * Math.pow(this.logarithmBase, 0.01),
                    Math.pow(this.logarithmBase, 0.04)
    ...
    U.prototype.render = function (a) {
      if (
        ...
        if (
          ...
          if (
            ((b = 1 === q % 2 ? (b.x << 0) + 0.5 : b.x << 0),
            (k = 1 === q % 2 ? (e.x << 0) + 0.5 : e.x << 0),
            "top" === this.scaleBreaks.parent._position
              ? ((e = this.chart.plotArea.y1),
                (m = (this.chart.plotArea.y2 + q / 2 + 0.5) << 0))
              : ((e = this.chart.plotArea.y2),
                (m = (this.chart.plotArea.y1 - q / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: b - q / 2, y1: e, x2: k + q / 2, y2: m }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
              ("top" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("bottom" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(b, m), this.ctx.lineTo(k, m), this.ctx.lineTo(k, e);
          ...
          if (
            ...
            (m = 1 === q % 2 ? (b.y << 0) + 0.5 : b.y << 0),
            "left" === this.scaleBreaks.parent._position
              ? ((b = this.chart.plotArea.x1),
                (k = (this.chart.plotArea.x2 + q / 2 + 0.5) << 0))
              : ((b = this.chart.plotArea.x2),
                (k = (this.chart.plotArea.x1 - q / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: b, y1: e - q / 2, x2: k, y2: m + q / 2 }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
              ("left" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("right" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(k, e), this.ctx.lineTo(k, m), this.ctx.lineTo(b, m);
          else if ("wavy" === this.type) {
            l = b;
            h = e;
            f = 0.5;
      ...
      if (0 < d) {
        ...
        if (
          ...
          (e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
            (k = this.chart.plotArea.y1),
            (m = this.chart.plotArea.y2),
            (this.bounds = { x1: e - d / 2, y1: k, x2: f + d / 2, y2: m });
        else if (
          "left" === this.parent._position ||
          "right" === this.parent._position
        )
          (k = m = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
            (e = this.chart.plotArea.x1),
            (f = this.chart.plotArea.x2),
            (this.bounds = { x1: e, y1: k - d / 2, x2: f, y2: m + d / 2 });
        this.ctx.moveTo(e, k);
        this.ctx.lineTo(f, m);
        this.ctx.stroke();
    ...
    aa.prototype.render = function (a, d, c) {
            ...
            q =
              "xySwapped" === this.chart.plotInfo.axisPlacement
                ...
                : Math.floor(
                  ...
                  (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0);
          this.valueFormatString = E.generateValueFormatString(
            this.parent.range,
            q
          );
        }
      ...
      p.lineWidth = q;
      p.save();
      this.labelFontSize = s(this.options.labelFontSize)
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var w = 0; w < this.parent.dataSeries.length; w++)
            (v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) &&
              0 <= v.index &&
              ((v.dataSeries = this.parent.dataSeries[w]),
              null !== v.dataPoint.y && r.push(v));
          v = null;
          ...
          w = 0;
          if (
            "rangeBar" === r[0].dataSeries.type ||
            "error" === r[0].dataSeries.type
          )
            for (
              var v = Math.abs(
                  a - this.parent.convertValueToPixel(r[w].dataPoint.y[0])
                ),
                u = 0,
                t = 0;
              t < r.length;
              ...
              if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                for (var x = 0; x < r[t].dataPoint.y.length; x++)
                  (u = Math.abs(
                    a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])
                  )),
                    u < v && ((v = u), (w = t));
              else
                (u = Math.abs(
                  a - this.parent.convertValueToPixel(r[t].dataPoint.y)
                )),
                  u < v && ((v = u), (w = t));
          else if ("stackedBar" === r[0].dataSeries.type)
            for (
              var v = Math.abs(
                  a - this.parent.convertValueToPixel(r[0].dataPoint.y)
                ),
                z = (u = 0),
                t = (w = 0);
              t < r.length;
              ...
              if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                for (x = 0; x < r[t].dataPoint.y.length; x++)
                  (u = Math.abs(
                    a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])
                  )),
                    u < v && ((v = u), (w = t));
            ...
            for (
              ...
              if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                ...
                (z += r[t].dataPoint.y),
                  (D = r[t].dataPoint.x.getTime
                    ? r[t].dataPoint.x.getTime()
                    : r[t].dataPoint.x),
                  (D = 100 * (z / r[t].dataSeries.plotUnit.dataPointYSums[D])),
                  (u = Math.abs(a - this.parent.convertValueToPixel(D))),
                  u < v && ((v = u), (w = t));
          else
            for (
              v = Math.abs(
          ...
          if (
            ...
            b = 0;
            if (
              "rangeBar" === this.parent.dataSeries[w].type ||
              "error" === this.parent.dataSeries[w].type
            ) {
              v = Math.abs(
                a - this.parent.convertValueToPixel(x.dataPoint.y[0])
              );
              for (t = u = 0; t < x.dataPoint.y.length; t++)
                (u = Math.abs(
                  a - this.parent.convertValueToPixel(x.dataPoint.y[t])
                )),
                  u < v && ((v = u), (b = t));
              m =
                1 === p.lineWidth % 2
                  ? (this.parent.convertValueToPixel(x.dataPoint.y[b]) << 0) +
                    0.5
                  : this.parent.convertValueToPixel(x.dataPoint.y[b]) << 0;
              ...
              h.text = this.labelFormatter
                ...
                : s(this.options.label)
                ? ea(c ? c : D, this.valueFormatString, this.chart._cultureInfo)
                : this.label;
            } else
              (m =
                1 === p.lineWidth % 2
                  ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5
                  : this.parent.convertValueToPixel(x.dataPoint.y) << 0),
                (h.text = this.labelFormatter
                  ? this.labelFormatter({
                      chart: this.chart,
                      axis: this.parent.options,
            ...
            this.bounds = { x1: b - q / 2, y1: f, x2: e + q / 2, y2: k };
            h.x = b - h.measureText().width / 2;
            h.x + h.width > this.chart.bounds.x2
              ? (h.x = this.chart.bounds.x2 - h.width)
              : h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1);
            h.y = this.parent.lineCoordinates.y2 + h.fontSize / 2 + 2;
            h.y + h.height > this.chart.bounds.y2
              ? (h.y = this.chart.bounds.y2 - h.height)
              : h.y < this.chart.bounds.y1 && (h.y = this.chart.bounds.y1);
          } else if (
            "left" === this.parent._position ||
            "right" === this.parent._position
          ) {
            f = k = l =
              1 === p.lineWidth % 2
                ? (this.parent.convertValueToPixel(x.dataPoint.x) << 0) + 0.5
                : this.parent.convertValueToPixel(x.dataPoint.x) << 0;
            b = this.chart.plotArea.x1;
            e = this.chart.plotArea.x2;
            this.bounds = { x1: b, y1: f - q / 2, x2: e, y2: k + q / 2 };
            D = !1;
            if (this.parent.labels)
              for (
                r = Math.ceil(this.parent.interval), t = 0;
                t < this.parent.viewportMaximum;
                t += r
              )
                if (this.parent.labels[t]) D = !0;
                else {
                  D = !1;
                  break;
                }
              ...
              if ("axisX" === this.parent.type)
                for (
                  t = this.parent.convertPixelToValue({ y: d }),
                    v = null,
                    w = 0;
                  w < this.parent.dataSeries.length;
                  w++
                )
                  (v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) &&
                    0 <= v.index &&
            ...
            h.y - h.fontSize / 2 < this.chart.bounds.y1
              ? (h.y = this.chart.bounds.y1 + h.fontSize / 2 + 2)
              : h.y + h.measureText().height - h.fontSize / 2 >
                ...
                (h.y =
                  ...
                  h.fontSize / 2);
            "left" === this.parent._position
              ? (h.x = this.parent.lineCoordinates.x2 - h.measureText().width)
              : "right" === this.parent._position &&
                (h.x = this.parent.lineCoordinates.x2);
          }
        } else if (
          "bottom" === this.parent._position ||
          "top" === this.parent._position
          ...
          if (D) {
            if ("axisX" === this.parent.type)
              for (
                t = this.parent.convertPixelToValue({ x: a }), v = null, w = 0;
                w < this.parent.dataSeries.length;
                w++
              )
                (v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) &&
          ...
          "bottom" === this.parent._position
            ...
            : "top" === this.parent._position &&
              (h.y =
                this.parent.lineCoordinates.y1 - h.height + h.fontSize / 2 + 2);
        } else if (
          "left" === this.parent._position ||
          "right" === this.parent._position
        ) {
          ...
          w = 0;
          if (
            "rangeColumn" === r[0].dataSeries.type ||
            "rangeArea" === r[0].dataSeries.type ||
            "error" === r[0].dataSeries.type ||
            "rangeSplineArea" === r[0].dataSeries.type ||
            "candlestick" === r[0].dataSeries.type ||
            "ohlc" === r[0].dataSeries.type ||
            "boxAndWhisker" === r[0].dataSeries.type
          )
            for (
              v = Math.abs(
                d - this.parent.convertValueToPixel(r[0].dataPoint.y[0])
              ),
                t = u = 0;
              t < r.length;
              t++
              ...
              if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                for (x = 0; x < r[t].dataPoint.y.length; x++)
                  (u = Math.abs(
                    d - this.parent.convertValueToPixel(r[t].dataPoint.y[x])
                  )),
                    u < v && ((v = u), (w = t));
              else
                (u = Math.abs(
                  d - this.parent.convertValueToPixel(r[t].dataPoint.y)
                )),
                  u < v && ((v = u), (w = t));
          else if (
            "stackedColumn" === r[0].dataSeries.type ||
            "stackedArea" === r[0].dataSeries.type
          )
            for (
              v = Math.abs(
                d - this.parent.convertValueToPixel(r[0].dataPoint.y)
              ),
                t = z = u = 0;
              t < r.length;
              t++
            ...
            "stackedColumn100" === r[0].dataSeries.type ||
            "stackedArea100" === r[0].dataSeries.type
          )
            for (
              v = Math.abs(
                d - this.parent.convertValueToPixel(r[0].dataPoint.y)
              ...
              if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                ...
                (z += r[t].dataPoint.y),
                  (D = r[t].dataPoint.x.getTime
                    ...
                    : r[t].dataPoint.x),
                  (D = 100 * (z / r[t].dataSeries.plotUnit.dataPointYSums[D])),
                  (u = Math.abs(d - this.parent.convertValueToPixel(D))),
                  u < v && ((v = u), (w = t));
          else
            for (
              v = Math.abs(
          ...
          if (
            ...
            for (t = u = 0; t < x.dataPoint.y.length; t++)
              (u = Math.abs(
                d - this.parent.convertValueToPixel(x.dataPoint.y[t])
              )),
                u < v && ((v = u), (b = t));
            l =
              1 === p.lineWidth % 2
                ? (this.parent.convertValueToPixel(x.dataPoint.y[b]) << 0) + 0.5
                : this.parent.convertValueToPixel(x.dataPoint.y[b]) << 0;
            h.text = this.labelFormatter
              ? this.labelFormatter({
                  chart: this.chart,
            ...
            "stackedColumn" === this.parent.dataSeries[w].type ||
            "stackedArea" === this.parent.dataSeries[w].type
          ) {
            ...
            "stackedColumn100" === this.parent.dataSeries[w].type ||
            "stackedArea100" === this.parent.dataSeries[w].type
          ) {
            v = Math.abs(d - this.parent.convertValueToPixel(r[0].dataPoint.y));
            z = u = 0;
            for (t = w; 0 <= t; t--)
              ...
              ? ((l =
                  1 === p.lineWidth % 2
                    ? (this.parent.convertValueToPixel(
                        x.dataSeries.dataPointEOs[x.index].cumulativeSum
                      ) <<
                        0) +
                      0.5
                    : this.parent.convertValueToPixel(
                ...
                (h.text = this.labelFormatter
                  ...
                  : s(this.options.label)
                  ? ea(
                      c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum,
                      this.valueFormatString,
                      this.chart._cultureInfo
                    )
                  : this.label),
          ...
          h.y - h.fontSize / 2 < this.chart.bounds.y1
            ...
            : h.y + h.measureText().height - h.fontSize / 2 >
                this.chart.bounds.y2 &&
              (h.y =
                this.chart.bounds.y2 - h.measureText().height + h.fontSize / 2);
          "left" === this.parent._position
            ? (h.x = this.parent.lineCoordinates.x2 - h.measureText().width)
            : "right" === this.parent._position &&
              (h.x = this.parent.lineCoordinates.x2);
        ...
        if (
          ...
          "top" === this.parent._position &&
            h.y - h.fontSize / 2 < this.chart.bounds.y1 &&
            (h.y = this.chart.bounds.y1 + h.fontSize / 2),
            "bottom" === this.parent._position &&
              this.parent.lineCoordinates.y2 -
                h.fontSize / 2 +
                h.measureText().height >
                this.chart.bounds.y2 &&
              (h.y = this.chart.bounds.y2 - h.height + h.fontSize / 2 + 2),
            b >= this.parent.convertValueToPixel(this.parent.viewportMinimum) &&
              e <=
                this.parent.convertValueToPixel(this.parent.viewportMaximum) &&
              (0 < q &&
                (p.moveTo(b, f),
                p.lineTo(e, k),
                p.stroke(),
              ...
              p.restore(),
              !s(h.text) &&
                ("number" === typeof h.text.valueOf() || 0 < h.text.length) &&
                h.render(!0));
        if (
          "left" === this.parent._position ||
          "right" === this.parent._position
          ...
          "left" === this.parent._position &&
            ...
            (h.x = this.chart.bounds.x1),
            "right" === this.parent._position &&
              h.x + h.measureText().width > this.chart.bounds.x2 &&
              (h.x = this.chart.bounds.x2 - h.measureText().width),
            k >= this.parent.convertValueToPixel(this.parent.viewportMaximum) &&
              f <=
                this.parent.convertValueToPixel(this.parent.viewportMinimum) &&
              (0 < q &&
                (p.moveTo(b, f),
                p.lineTo(e, k),
                p.stroke(),
        ...
        if (
          ...
          (b = e = m = 1 === p.lineWidth % 2 ? (a << 0) + 0.5 : a << 0),
            (f = this.chart.plotArea.y1),
            (k = this.chart.plotArea.y2),
            (this.bounds = { x1: b - q / 2, y1: f, x2: e + q / 2, y2: k });
        else if (
          ...
          (f = k = l = 1 === p.lineWidth % 2 ? (d << 0) + 0.5 : d << 0),
            (b = this.chart.plotArea.x1),
            (e = this.chart.plotArea.x2),
            (this.bounds = { x1: b, y1: f - q / 2, x2: e, y2: k + q / 2 });
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
            ...
            h.y - h.fontSize / 2 < this.chart.bounds.y1
              ...
              : h.y + h.measureText().height - h.fontSize / 2 >
                ...
                (h.y =
                  ...
                  h.fontSize / 2);
            "left" === this.parent._position
              ? (h.x = this.parent.lineCoordinates.x1 - h.measureText().width)
              : "right" === this.parent._position &&
                (h.x = this.parent.lineCoordinates.x2);
          } else {
            if (
          ...
          (h.text = this.labelFormatter
            ...
            "left" === this.parent._position
              ...
              : "right" === this.parent._position &&
                (h.x = this.parent.lineCoordinates.x2);
        "left" === this.parent._position && h.x < this.chart.bounds.x1
          ? (h.x = this.chart.bounds.x1)
          : "right" === this.parent._position &&
            h.x + h.measureText().width > this.chart.bounds.x2
          ? (h.x = this.chart.bounds.x2 - h.measureText().width)
          ...
          : "bottom" === this.parent._position &&
            ...
            (h.y = this.chart.bounds.y2 - h.height + h.fontSize / 2 + 2);
        0 < q &&
          (p.moveTo(b, f), p.lineTo(e, k), p.stroke(), (this._hidden = !1));
        p.restore();
        !s(h.text) &&
          ("number" === typeof h.text.valueOf() || 0 < h.text.length) &&
          h.render(!0);
    ...
    X.prototype._updateToolTip = function (a, d, c) {
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var l = 0; l < this.chart.axisX.length; l++) {
                for (
                  var k = this.chart.axisX[l].convertPixelToValue({ y: d }),
                    h = null,
                    b = 0;
                  b < this.chart.axisX[l].dataSeries.length;
                  b++
                )
                  (h = this.chart.axisX[l].dataSeries[b].getDataPointAtX(
                    k,
                    c
                  )) &&
                    0 <= h.index &&
                    ((h.dataSeries = this.chart.axisX[l].dataSeries[b]),
                    null !== h.dataPoint.y && m.push(h));
                h = null;
              }
            if (this.chart.axisX2)
              for (l = 0; l < this.chart.axisX2.length; l++) {
                k = this.chart.axisX2[l].convertPixelToValue({ y: d });
                h = null;
                for (b = 0; b < this.chart.axisX2[l].dataSeries.length; b++)
                  (h = this.chart.axisX2[l].dataSeries[b].getDataPointAtX(
                    k,
                    c
                  )) &&
                    0 <= h.index &&
                    ((h.dataSeries = this.chart.axisX2[l].dataSeries[b]),
                    null !== h.dataPoint.y && m.push(h));
                h = null;
              }
          } else {
            ...
            if (this.chart.axisX)
              for (l = 0; l < this.chart.axisX.length; l++)
                for (
                  k = this.chart.axisX[l].convertPixelToValue({ x: a }),
                    h = null,
                    b = 0;
                  b < this.chart.axisX[l].dataSeries.length;
                  b++
            ...
            if (this.chart.axisX2)
              for (l = 0; l < this.chart.axisX2.length; l++)
                for (
                  k = this.chart.axisX2[l].convertPixelToValue({ x: a }),
                    h = null,
                    b = 0;
                  b < this.chart.axisX2[l].dataSeries.length;
                  b++
                )
                  (h = this.chart.axisX2[l].dataSeries[b].getDataPointAtX(
                    k,
          ...
          if ((h = this.chart.getDataPointAtXY(a, d, c)))
            (this.currentDataPointIndex = h.dataPointIndex),
              (this.currentSeriesIndex = h.dataSeries.index);
          else if (t)
            if (
              ((h = Za(a, d, this.chart._eventManager.ghostCtx)),
              0 < h &&
                "undefined" !== typeof this.chart._eventManager.objectMap[h])
            ) {
              ...
              if (h.dataSeries.axisY)
                if (0 < h.dataPoint.y.length) {
                  for (b = c = 0; b < h.dataPoint.y.length; b++)
                    h.dataPoint.y[b] < h.dataSeries.axisY.viewportMinimum
                      ? c--
                      : h.dataPoint.y[b] > h.dataSeries.axisY.viewportMaximum &&
                        c++;
                  c < h.dataPoint.y.length &&
                    c > -h.dataPoint.y.length &&
                    f.push(h);
                } else
                  "column" === e.type || "bar" === e.type
                    ...
                    ? ((c =
                        this.chart._eventManager.objectMap[
                          e.dataPointIds[h.index]
                        ].size / 2),
                      h.dataPoint.y >= h.dataSeries.axisY.viewportMinimum - c &&
                        h.dataPoint.y <=
                          h.dataSeries.axisY.viewportMaximum + c &&
                        f.push(h))
                    : "waterfall" === e.type
                    ? ((c = 0),
                      h.cumulativeSumYStartValue <
        ...
        if (0 < f.length) {
          ...
          if (this.enabled) {
            var r = "",
              r = this.getToolTipInnerHTML({ entries: f });
            if (null !== r) {
              this.contentDiv.innerHTML = r;
              c = !1;
              "none" === this.container.style.display &&
                ((c = !0), (this.container.style.display = "block"));
              try {
        ...
        if (
          ...
          !1 === f.highlightEnabled ||
            ...
            "rangeSplineArea" === b.type
              ...
              ? qa(d, e.funnelSection, 0.3, "white")
              : "candlestick" === b.type
              ? ((d.globalAlpha = 1),
    ...
    X.prototype.getToolTipInnerHTML = function (a) {
      a = a.entries;
      for (
        var d = null, c = null, b = null, e = 0, f = "", k = !0, l = 0;
        l < a.length;
        l++
      )
                ...
                : this.chart.axisX2 &&
                  ...
                  (h +=
                    "undefined" !== typeof this.chart.axisX2[0].labels[b.x]
                      ...
                      : "{x}"),
              (h += "</br>"),
              (h = this.chart.replaceKeywordsWithValue(h, b, c, e))),
    ...
    X.prototype.showAtX = function (a, d) {
      ...
      if (this.shared)
        for (var k = 0; k < this.chart.data.length; k++)
          (c = this.chart.data[k]),
    ...
    var L = {
      ...
      W = {
        drawMarker: function (a, d, c, b, e, f, k, l) {
          if (c) {
            var s = 1;
